...
package com.nokia.tools.variant.editor.model.util;
...
public class UIModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected UIModelSwitch<Adapter> modelSwitch =
		new UIModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUIGroup(UIGroup object) {
				return createUIGroupAdapter();
			}
			@Override
			public Adapter caseUISetting(UISetting object) {
				return createUISettingAdapter();
			}
			@Override
			public Adapter caseUIMessage(UIMessage object) {
				return createUIMessageAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.editor.model.UIModel <em>UI Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.editor.model.UIGroup <em>UI Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.editor.model.UISetting <em>UI Setting</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUISettingAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.editor.model.UIMessage <em>UI Message</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUIMessageAdapter() {
		return null;
	}
