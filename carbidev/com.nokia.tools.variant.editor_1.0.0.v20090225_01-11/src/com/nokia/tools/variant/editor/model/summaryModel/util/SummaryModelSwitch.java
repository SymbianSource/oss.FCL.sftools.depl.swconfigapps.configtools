 ...
 * @generated
 */
public class SummaryModelSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SummaryModelPackage.UI_SUMMARY_MODEL: {
				UISummaryModel uiSummaryModel = (UISummaryModel)theEObject;
				T result = caseUISummaryModel(uiSummaryModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SummaryModelPackage.UI_ELEMENT: {
				UIElement uiElement = (UIElement)theEObject;
				T result = caseUIElement(uiElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SummaryModelPackage.UI_SUMMARY_GROUP: {
				UISummaryGroup uiSummaryGroup = (UISummaryGroup)theEObject;
				T result = caseUISummaryGroup(uiSummaryGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SummaryModelPackage.NOTE: {
				Note note = (Note)theEObject;
				T result = caseNote(note);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SummaryModelPackage.HISTORY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UI Summary Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UI Summary Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUISummaryModel(UISummaryModel object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UI Summary Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UI Summary Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUISummaryGroup(UISummaryGroup object) {
		return null;
	}
