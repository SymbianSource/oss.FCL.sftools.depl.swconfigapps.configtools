 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.editor.model.summaryModel.impl.HistoryImpl#getNote <em>Note</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HistoryImpl extends EObjectImpl implements History {
	...
	protected EClass eStaticClass() {
		return SummaryModelPackage.Literals.HISTORY;
	}
	...
	public EList<Note> getNote() {
		if (note == null) {
			note = new EObjectContainmentEList<Note>(Note.class, this, SummaryModelPackage.HISTORY__NOTE);
		}
		return note;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SummaryModelPackage.HISTORY__NOTE:
