...
import com.nokia.tools.variant.editor.commands.SetPropertyCommand;
 ...
 * updated (command is executed). This listener is created for the AVR element
 * Text.
 * 
 */
public class AvrTextBoxListener implements Listener {

	private Text textBox;
	private UIElement setting;
	private IWorkbenchPart activeEditor;

	public AvrTextBoxListener(Text textBox, UIElement setting,
	...
	private void updateTextBox() {
		...
		if (textValue != null && !textValue.equals(note)) {
			SetPropertyCommand command = new SetPropertyCommand(setting, textValue);
	 ...
	 */
	private void executeCommand(SetPropertyCommand command, IWorkbenchPart editor) {
