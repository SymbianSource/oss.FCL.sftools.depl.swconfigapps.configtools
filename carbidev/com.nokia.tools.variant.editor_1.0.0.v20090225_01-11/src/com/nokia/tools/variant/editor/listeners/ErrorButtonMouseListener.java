...
public class ErrorButtonMouseListener implements MouseListener{
	private CPFEditor editor;

	public ErrorButtonMouseListener(CPFEditor editor){
		this.editor = editor;
	}
	...
	public void mouseDown(MouseEvent e) {
		...
		if (selectedGroup != null
			...
			UIGroup group = editor.getViewModelToUIModelConvertor()
					.createErrorsForGroup(selectedGroup, editor.getErrorsRoot());
			editor.setDirtySorting(false);
			editor.setErrorSorting(true);
