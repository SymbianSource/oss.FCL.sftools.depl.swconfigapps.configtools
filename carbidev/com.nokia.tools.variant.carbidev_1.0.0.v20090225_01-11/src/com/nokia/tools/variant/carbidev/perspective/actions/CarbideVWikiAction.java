...
/**
 * Run Wiki page in external browser.
 *
 */
public class CarbideVWikiAction implements IWorkbenchWindowActionDelegate {

	private static final String TARGET_URL = "https://s60wiki.nokia.com/S60Wiki/Carbide.v";
