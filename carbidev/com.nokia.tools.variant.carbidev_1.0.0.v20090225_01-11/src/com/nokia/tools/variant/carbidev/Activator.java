...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.nokia.tools.variant.carbidev";
	...
	public static PropertyResourceBundle getPluginProperties() {
		if (pluginProperties == null) {
			try {
				pluginProperties = new PropertyResourceBundle(FileLocator
						.openStream(getDefault().getBundle(), new Path(
								PLUGIN_PROPERTIES), false));
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
