...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EApplication Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getLockName <em>Lock Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getLockIcon <em>Lock Icon</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getLockDelete <em>Lock Delete</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getLockOrganize <em>Lock Organize</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getIconFile <em>Icon File</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getM3gIconFile <em>M3g Icon File</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getIconId <em>Icon Id</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getMaskId <em>Mask Id</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getIconSkinMajorId <em>Icon Skin Major Id</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getIconSkinMinorId <em>Icon Skin Minor Id</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getHideChangeSkin <em>Hide Change Skin</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getHideMemDetails <em>Hide Mem Details</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getHideDownload <em>Hide Download</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getHideAnimatedIcons <em>Hide Animated Icons</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getTitleName <em>Title Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getShortName <em>Short Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getLongName <em>Long Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getUid <em>Uid</em>}</li>
 *   <li>{@link com.nokia.tools.vct.appshell.appshellmodel.impl.EApplicationElementImpl#getView <em>View</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EApplicationElementImpl extends EObjectImpl implements EApplicationElement {
	/**
	 ...
	 * @generated
	 */
	protected EApplicationElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EAppshellModelPackage.Literals.EAPPLICATION_ELEMENT;
	}
	...
	public void setLockName(EBooleanFlag newLockName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_NAME, oldLockName, lockName));
	}
	...
	public void setLockIcon(EBooleanFlag newLockIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_ICON, oldLockIcon, lockIcon));
	}
	...
	public void setLockDelete(EBooleanFlag newLockDelete) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_DELETE, oldLockDelete, lockDelete));
	}
	...
	public void setLockOrganize(EBooleanFlag newLockOrganize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_ORGANIZE, oldLockOrganize, lockOrganize));
	}
	...
	public void setHideChangeSkin(EBooleanFlag newHideChangeSkin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_CHANGE_SKIN, oldHideChangeSkin, hideChangeSkin));
	}
	...
	public void setHideMemDetails(EBooleanFlag newHideMemDetails) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_MEM_DETAILS, oldHideMemDetails, hideMemDetails));
	}
	...
	public void setHideDownload(EBooleanFlag newHideDownload) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_DOWNLOAD, oldHideDownload, hideDownload));
	}
	...
	public void setHideAnimatedIcons(EBooleanFlag newHideAnimatedIcons) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_ANIMATED_ICONS, oldHideAnimatedIcons, hideAnimatedIcons));
	}
	...
	public void setIconFile(String newIconFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_FILE, oldIconFile, iconFile));
	}
	...
	public void setM3gIconFile(String newM3gIconFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__M3G_ICON_FILE, oldM3gIconFile, m3gIconFile));
	}
	...
	public void setIconId(String newIconId) {
		...
		iconId = newIconId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_ID, oldIconId, iconId));
	}
	...
	public void setMaskId(String newMaskId) {
		...
		maskId = newMaskId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__MASK_ID, oldMaskId, maskId));
	}
	...
	public void setIconSkinMajorId(String newIconSkinMajorId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MAJOR_ID, oldIconSkinMajorId, iconSkinMajorId));
	}
	...
	public void setIconSkinMinorId(String newIconSkinMinorId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MINOR_ID, oldIconSkinMinorId, iconSkinMinorId));
	}
	...
	public void setUid(String newUid) {
		...
		uid = newUid;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__UID, oldUid, uid));
	}
	...
	public void setView(String newView) {
		...
		view = newView;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__VIEW, oldView, view));
	}
	...
	public void setTitleName(String newTitleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__TITLE_NAME, oldTitleName, titleName));
	}
	...
	public void setShortName(String newShortName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__SHORT_NAME, oldShortName, shortName));
	}
	...
	public void setLongName(String newLongName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EAppshellModelPackage.EAPPLICATION_ELEMENT__LONG_NAME, oldLongName, longName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_NAME:
				return getLockName();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_ICON:
				return getLockIcon();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_DELETE:
				return getLockDelete();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__LOCK_ORGANIZE:
				return getLockOrganize();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_FILE:
				return getIconFile();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__M3G_ICON_FILE:
				return getM3gIconFile();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_ID:
				return getIconId();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__MASK_ID:
				return getMaskId();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MAJOR_ID:
				return getIconSkinMajorId();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MINOR_ID:
				return getIconSkinMinorId();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_CHANGE_SKIN:
				return getHideChangeSkin();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_MEM_DETAILS:
				return getHideMemDetails();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_DOWNLOAD:
				return getHideDownload();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_ANIMATED_ICONS:
				return getHideAnimatedIcons();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__TITLE_NAME:
				return getTitleName();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__SHORT_NAME:
				return getShortName();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__LONG_NAME:
				return getLongName();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__UID:
				return getUid();
			case EAppshellModelPackage.EAPPLICATION_ELEMENT__VIEW:
				return getView();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EIconDescriptor.class) {
			switch (derivedFeatureID) {
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_FILE: return EAppshellModelPackage.EICON_DESCRIPTOR__ICON_FILE;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__M3G_ICON_FILE: return EAppshellModelPackage.EICON_DESCRIPTOR__M3G_ICON_FILE;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_ID: return EAppshellModelPackage.EICON_DESCRIPTOR__ICON_ID;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__MASK_ID: return EAppshellModelPackage.EICON_DESCRIPTOR__MASK_ID;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MAJOR_ID: return EAppshellModelPackage.EICON_DESCRIPTOR__ICON_SKIN_MAJOR_ID;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MINOR_ID: return EAppshellModelPackage.EICON_DESCRIPTOR__ICON_SKIN_MINOR_ID;
				default: return -1;
			}
		}
		if (baseClass == EHideDescriptor.class) {
			switch (derivedFeatureID) {
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_CHANGE_SKIN: return EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_CHANGE_SKIN;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_MEM_DETAILS: return EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_MEM_DETAILS;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_DOWNLOAD: return EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_DOWNLOAD;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_ANIMATED_ICONS: return EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_ANIMATED_ICONS;
				default: return -1;
			}
		}
		if (baseClass == ENameDescriptor.class) {
			switch (derivedFeatureID) {
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__TITLE_NAME: return EAppshellModelPackage.ENAME_DESCRIPTOR__TITLE_NAME;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__SHORT_NAME: return EAppshellModelPackage.ENAME_DESCRIPTOR__SHORT_NAME;
				case EAppshellModelPackage.EAPPLICATION_ELEMENT__LONG_NAME: return EAppshellModelPackage.ENAME_DESCRIPTOR__LONG_NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EIconDescriptor.class) {
			switch (baseFeatureID) {
				case EAppshellModelPackage.EICON_DESCRIPTOR__ICON_FILE: return EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_FILE;
				case EAppshellModelPackage.EICON_DESCRIPTOR__M3G_ICON_FILE: return EAppshellModelPackage.EAPPLICATION_ELEMENT__M3G_ICON_FILE;
				case EAppshellModelPackage.EICON_DESCRIPTOR__ICON_ID: return EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_ID;
				case EAppshellModelPackage.EICON_DESCRIPTOR__MASK_ID: return EAppshellModelPackage.EAPPLICATION_ELEMENT__MASK_ID;
				case EAppshellModelPackage.EICON_DESCRIPTOR__ICON_SKIN_MAJOR_ID: return EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MAJOR_ID;
				case EAppshellModelPackage.EICON_DESCRIPTOR__ICON_SKIN_MINOR_ID: return EAppshellModelPackage.EAPPLICATION_ELEMENT__ICON_SKIN_MINOR_ID;
				default: return -1;
			}
		}
		if (baseClass == EHideDescriptor.class) {
			switch (baseFeatureID) {
				case EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_CHANGE_SKIN: return EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_CHANGE_SKIN;
				case EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_MEM_DETAILS: return EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_MEM_DETAILS;
				case EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_DOWNLOAD: return EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_DOWNLOAD;
				case EAppshellModelPackage.EHIDE_DESCRIPTOR__HIDE_ANIMATED_ICONS: return EAppshellModelPackage.EAPPLICATION_ELEMENT__HIDE_ANIMATED_ICONS;
				default: return -1;
			}
		}
		if (baseClass == ENameDescriptor.class) {
			switch (baseFeatureID) {
				case EAppshellModelPackage.ENAME_DESCRIPTOR__TITLE_NAME: return EAppshellModelPackage.EAPPLICATION_ELEMENT__TITLE_NAME;
				case EAppshellModelPackage.ENAME_DESCRIPTOR__SHORT_NAME: return EAppshellModelPackage.EAPPLICATION_ELEMENT__SHORT_NAME;
				case EAppshellModelPackage.ENAME_DESCRIPTOR__LONG_NAME: return EAppshellModelPackage.EAPPLICATION_ELEMENT__LONG_NAME;
				default: return -1;
			}
		}
