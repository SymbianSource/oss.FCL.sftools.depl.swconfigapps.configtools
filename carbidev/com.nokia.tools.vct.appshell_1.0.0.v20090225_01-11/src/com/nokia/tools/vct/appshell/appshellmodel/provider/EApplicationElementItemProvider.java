...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.vct.appshell.appshellmodel.EApplicationElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EApplicationElementItemProvider
	 ...
	 * @generated
	 */
	public EApplicationElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addUidPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EApplicationElement_uid_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EApplicationElement_uid_feature", "_UI_EApplicationElement_type"),
				 EAppshellModelPackage.Literals.EAPPLICATION_ELEMENT__UID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EApplicationElement_view_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EApplicationElement_view_feature", "_UI_EApplicationElement_type"),
				 EAppshellModelPackage.Literals.EAPPLICATION_ELEMENT__VIEW,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns EApplicationElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EApplicationElement"));
	}
	...
	public String getText(Object object) {
		String label = ((EApplicationElement)object).getUid();
		return label == null || label.length() == 0 ?
			getString("_UI_EApplicationElement_type") :
			getString("_UI_EApplicationElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EApplicationElement.class)) {
