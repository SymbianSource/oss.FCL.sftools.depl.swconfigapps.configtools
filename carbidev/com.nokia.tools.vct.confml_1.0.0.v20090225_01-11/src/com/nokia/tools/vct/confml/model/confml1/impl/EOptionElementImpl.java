 ...
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EOptionElementImpl#getHref <em>Href</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EOptionElementImpl#getTitle <em>Title</em>}</li>
...
public class EOptionElementImpl extends ECommonAttrsImpl implements
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.EOPTION_ELEMENT__HREF, oldHref, href));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.EOPTION_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EConfML1Package.EOPTION_ELEMENT__LINKS:
			return getLinks();
		case EConfML1Package.EOPTION_ELEMENT__HREF:
			return getHref();
		case EConfML1Package.EOPTION_ELEMENT__TITLE:
			return getTitle();
		case EConfML1Package.EOPTION_ELEMENT__DESCRIPTIONS:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EXLinkReference.class) {
			...
			case EConfML1Package.EX_LINK_REFERENCE__HREF:
				return EConfML1Package.EOPTION_ELEMENT__HREF;
			case EConfML1Package.EX_LINK_REFERENCE__TITLE:
				return EConfML1Package.EOPTION_ELEMENT__TITLE;
			default:
				return -1;
			}
		}
