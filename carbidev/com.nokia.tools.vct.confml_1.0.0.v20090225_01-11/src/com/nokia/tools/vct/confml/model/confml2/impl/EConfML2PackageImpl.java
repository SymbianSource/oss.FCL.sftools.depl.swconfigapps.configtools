...
public class EConfML2PackageImpl extends EPackageImpl implements
	 ...
	 * @see com.nokia.tools.vct.confml.model.confml2.EConfML2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		eOptionElementEClass.getESuperTypes().add(this.getEIconElement());
		...
		ePropertyElementEClass.getESuperTypes().add(this.getEIconElement());
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getELinkContainer_Links(), source, new String[] { "kind",
				"element", "name", "link", "namespace",
				"http://www.s60.com/xml/confml/1", "group", "#contents:0" });
