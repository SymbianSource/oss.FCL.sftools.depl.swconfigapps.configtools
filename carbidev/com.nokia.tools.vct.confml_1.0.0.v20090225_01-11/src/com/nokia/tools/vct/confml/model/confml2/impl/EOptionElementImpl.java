 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getHref <em>Href</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EOptionElementImpl#getMap <em>Map</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EOptionElementImpl extends ECommonAttrsImpl implements
	...
	protected EClass eStaticClass() {
		return EConfML2Package.Literals.EOPTION_ELEMENT;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML2Package.EOPTION_ELEMENT__CONTENTS);
		}
		return contents;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__HREF, oldHref, href));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__VALUE, oldValue, value));
	}
	...
	public void setRelevant(String newRelevant) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__RELEVANT, oldRelevant,
					relevant));
	}
	...
	public void setMap(String newMap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EOPTION_ELEMENT__MAP, oldMap, map));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case EConfML2Package.EOPTION_ELEMENT__CONTENTS:
			return ((InternalEList<?>) getContents()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.EOPTION_ELEMENT__LINKS:
			return ((InternalEList<?>) getLinks()).basicRemove(otherEnd, msgs);
		case EConfML2Package.EOPTION_ELEMENT__DESCRIPTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EConfML2Package.EOPTION_ELEMENT__LINKS:
			return getLinks();
		case EConfML2Package.EOPTION_ELEMENT__HREF:
			return getHref();
		case EConfML2Package.EOPTION_ELEMENT__TITLE:
			return getTitle();
		case EConfML2Package.EOPTION_ELEMENT__DESCRIPTIONS:
			return getDescriptions();
		case EConfML2Package.EOPTION_ELEMENT__NAME:
			return getName();
		case EConfML2Package.EOPTION_ELEMENT__VALUE:
			return getValue();
		case EConfML2Package.EOPTION_ELEMENT__RELEVANT:
			return getRelevant();
		case EConfML2Package.EOPTION_ELEMENT__MAP:
			return getMap();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EContents.class) {
			...
			case EConfML2Package.ECONTENTS__CONTENTS:
				return EConfML2Package.EOPTION_ELEMENT__CONTENTS;
			default:
				return -1;
			}
		}
		if (baseClass == ELinkContainer.class) {
			...
			case EConfML2Package.ELINK_CONTAINER__LINKS:
				return EConfML2Package.EOPTION_ELEMENT__LINKS;
			default:
				return -1;
			}
		}
		if (baseClass == EXLinkReference.class) {
			...
			case EConfML2Package.EX_LINK_REFERENCE__HREF:
				return EConfML2Package.EOPTION_ELEMENT__HREF;
			case EConfML2Package.EX_LINK_REFERENCE__TITLE:
				return EConfML2Package.EOPTION_ELEMENT__TITLE;
			default:
				return -1;
			}
		}
		...
		if (baseClass == EDescriptionContainer.class) {
			...
			case EConfML2Package.EDESCRIPTION_CONTAINER__DESCRIPTIONS:
				return EConfML2Package.EOPTION_ELEMENT__DESCRIPTIONS;
			default:
				return -1;
			}
		}
