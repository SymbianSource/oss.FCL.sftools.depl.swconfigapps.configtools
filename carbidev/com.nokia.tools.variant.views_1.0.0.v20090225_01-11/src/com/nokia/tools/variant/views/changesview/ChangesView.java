...
public class ChangesView extends PageBookView {

	public static final String VIEW_ID = "com.nokia.tools.variant.views.changesview";
	...
	protected PageRec doCreatePage(IWorkbenchPart part) {
		...
		if (adapter instanceof View) {
			...
			ChangesViewPage page = new ChangesViewPage(view);
			initPage(page);
			page.createControl(getPageBook());
