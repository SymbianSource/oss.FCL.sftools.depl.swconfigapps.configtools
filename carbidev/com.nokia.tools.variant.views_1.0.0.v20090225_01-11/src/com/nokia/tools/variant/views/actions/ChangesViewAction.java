...
public class ChangesViewAction implements IWorkbenchWindowActionDelegate {
	...
	public void init(IWorkbenchWindow window) {
		partListener = new IPartListener() {
				...
				public void partClosed(IWorkbenchPart part) {
					...
					if (part instanceof ChangesView) {
						
						ChangesView changesView = (ChangesView) part;
						String id = changesView.getViewSite().getId();					
						
						if(id.equals(ChangesView.VIEW_ID)) {
	...
	public void run(IAction action) {
		...
		if(action.isChecked()) {
			...
			try {
				workbenchPage.showView(ChangesView.VIEW_ID);
			...
			IViewPart viewPart = workbenchPage.findView(ChangesView.VIEW_ID);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		viewActionRegistry.setAction(ChangesView.VIEW_ID, action);
	}
