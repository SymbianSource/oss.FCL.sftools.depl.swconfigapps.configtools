...
package com.nokia.tools.variant.views.errormodel.util;
...
public class ErrormodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ErrormodelSwitch<Adapter> modelSwitch =
		new ErrormodelSwitch<Adapter>() {
			@Override
			public Adapter caseErrorsRoot(ErrorsRoot object) {
				return createErrorsRootAdapter();
			}
			@Override
			public Adapter caseError(com.nokia.tools.variant.views.errormodel.Error object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.views.errormodel.ErrorsRoot <em>Errors Root</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createErrorsRootAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.nokia.tools.variant.views.errormodel.Error <em>Error</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
