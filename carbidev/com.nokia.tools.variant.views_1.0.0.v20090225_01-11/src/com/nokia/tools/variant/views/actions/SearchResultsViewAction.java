...
public class SearchResultsViewAction implements IWorkbenchWindowActionDelegate {
	...
	public void init(IWorkbenchWindow window) {
		partListener = new IPartListener() {
				...
				public void partClosed(IWorkbenchPart part) {
					...
					if (part instanceof SearchResultsView) {
						
						SearchResultsView searchResultsView = (SearchResultsView) part;
						String id = searchResultsView.getViewSite().getId();					
						
						if(id.equals(SearchResultsView.VIEW_ID)) {
	...
	public void run(IAction action) {
		...
		if(action.isChecked()) {
			...
			try {
				workbenchPage.showView(SearchResultsView.VIEW_ID);
			...
			IViewPart viewPart = workbenchPage.findView(SearchResultsView.VIEW_ID);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		viewActionRegistry.setAction(SearchResultsView.VIEW_ID, action);
	}
