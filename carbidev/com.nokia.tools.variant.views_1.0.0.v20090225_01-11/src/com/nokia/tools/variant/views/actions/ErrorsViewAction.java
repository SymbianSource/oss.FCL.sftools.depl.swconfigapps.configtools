...
public class ErrorsViewAction implements IWorkbenchWindowActionDelegate {
	...
	public void init(IWorkbenchWindow window) {
		partListener = new IPartListener() {
				...
				public void partClosed(IWorkbenchPart part) {
					...
					if (part instanceof ErrorsView) {
						
						ErrorsView errorsView = (ErrorsView) part;
						String id = errorsView.getViewSite().getId();					
						
						if(id.equals(ErrorsView.VIEW_ID)) {
	...
	public void run(IAction action) {
		...
		if(action.isChecked()) {
			...
			try {
				workbenchPage.showView(ErrorsView.VIEW_ID);
			...
			IViewPart viewPart = workbenchPage.findView(ErrorsView.VIEW_ID);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		viewActionRegistry.setAction(ErrorsView.VIEW_ID, action);
	}
