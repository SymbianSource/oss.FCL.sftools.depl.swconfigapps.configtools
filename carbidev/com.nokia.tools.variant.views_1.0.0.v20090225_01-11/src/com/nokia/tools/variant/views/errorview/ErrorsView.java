...
public class ErrorsView extends PageBookView {

	public static final String VIEW_ID = "com.nokia.tools.variant.views.errorsview";
	...
	protected PageRec doCreatePage(IWorkbenchPart part) {
		Object adapter = part.getAdapter(ErrorsRoot.class);
		if (adapter instanceof ErrorsRoot) {
			ErrorsRoot er = (ErrorsRoot) adapter;
			ErrorsViewPage page = new ErrorsViewPage(er);
			initPage(page);
