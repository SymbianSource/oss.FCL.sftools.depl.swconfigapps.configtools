...
public class NotesViewAction implements IWorkbenchWindowActionDelegate {
	...
	public void init(IWorkbenchWindow window) {
		partListener = new IPartListener() {
				...
				public void partClosed(IWorkbenchPart part) {
					...
					if (part instanceof NotesView) {
						
						NotesView notesView = (NotesView) part;
						String id = notesView.getViewSite().getId();					
						
						if(id.equals(NotesView.VIEW_ID)) {
	...
	public void run(IAction action) {
		...
		if(action.isChecked()) {
			...
			try {
				workbenchPage.showView(NotesView.VIEW_ID);
			...
			IViewPart viewPart = workbenchPage.findView(NotesView.VIEW_ID);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		viewActionRegistry.setAction(NotesView.VIEW_ID, action);
	}
