...
public class PreviewViewAction implements IWorkbenchWindowActionDelegate {
		...
		partListener = new IPartListener() {
				...
				public void partClosed(IWorkbenchPart part) {
					...
					if (part instanceof PreviewView) {
						...
						PreviewView previewView = (PreviewView) part;
						String id = previewView.getViewSite().getId();					
						
						if(id.equals(PreviewView.VIEW_ID)) {
	...
	public void run(IAction action) {
		...
		if(action.isChecked()) {
			...
			try {
				workbenchPage.showView(PreviewView.VIEW_ID);
			...
			IViewPart viewPart = workbenchPage.findView(PreviewView.VIEW_ID);
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		viewActionRegistry.setAction(PreviewView.VIEW_ID, action);
	}
