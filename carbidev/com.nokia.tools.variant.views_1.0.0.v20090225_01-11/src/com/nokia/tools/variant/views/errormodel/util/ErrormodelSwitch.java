...
public class ErrormodelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ErrormodelPackage.ERRORS_ROOT: {
				ErrorsRoot errorsRoot = (ErrorsRoot)theEObject;
				T result = caseErrorsRoot(errorsRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ErrormodelPackage.ERROR: {
				com.nokia.tools.variant.views.errormodel.Error error = (com.nokia.tools.variant.views.errormodel.Error)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Errors Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Errors Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseErrorsRoot(ErrorsRoot object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseError(com.nokia.tools.variant.views.errormodel.Error object) {
		return null;
	}
