...
public class ResourceCategories {
	...
	public static final String EXTENSION_POINT_ID = 
		"com.nokia.tools.variant.resourcelibrary.resourceCategory";
	 ...
	 */	
	public static ResourceCategory getResourceCategory(FileSystemElement res) {
		if (!initialized) init();
	...
	public static String getResourceCategoryText(FileSystemElement res) {
		// Since this will be used for resource library, the object is		
		// always IResource
		IContentType type = null;
		if (res instanceof File) {
			IContentDescription descr = ((File)res).getContentDescription();
	...
	public static int compare(FileSystemElement r1, FileSystemElement r2) {
		// In the battle, everything wins the normal file
		int t1 = (r1 instanceof Directory)?1:0;
		int t2 = (r2 instanceof Directory)?1:0;
		
		// Same type
		if (t1 == t2 && t2 == 1)// directory
			return r2.getName().compareToIgnoreCase(r1.getName());
		if (r1 instanceof Directory) return 1;
		if (r2 instanceof Directory) return -1;
