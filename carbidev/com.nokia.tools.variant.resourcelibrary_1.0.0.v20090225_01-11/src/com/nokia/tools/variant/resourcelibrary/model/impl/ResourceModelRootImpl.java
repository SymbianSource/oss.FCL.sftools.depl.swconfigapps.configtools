 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.resourcelibrary.model.impl.ResourceModelRootImpl#getTempDirPath <em>Temp Dir Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ResourceModelRootImpl extends DirectoryImpl implements ResourceModelRoot {
	/**
	 ...
	 * @generated
	 */
	protected ResourceModelRootImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return resourcesPackage.Literals.RESOURCE_MODEL_ROOT;
	}
	...
	public void setTempDirPath(String newTempDirPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, resourcesPackage.RESOURCE_MODEL_ROOT__TEMP_DIR_PATH, oldTempDirPath, tempDirPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case resourcesPackage.RESOURCE_MODEL_ROOT__TEMP_DIR_PATH:
