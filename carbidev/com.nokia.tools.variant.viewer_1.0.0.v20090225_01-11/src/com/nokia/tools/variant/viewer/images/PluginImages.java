...
package com.nokia.tools.variant.viewer.images;
...
public final class PluginImages {
	...
	public static Color ACTIVATED_BACKGROUND_COLOR;
	public static Color DEACTIVATED_BACKGROUND_COLOR;
	public static Image MRK_NOTE;
	public static Image MRK_DIRTY;
	public static Image MRK_ERROR;
	static {
		...
		ACTIVATED_BACKGROUND_COLOR = new Color(null, 232, 242, 255);
		DEACTIVATED_BACKGROUND_COLOR = Display.getCurrent().getSystemColor(SWT.COLOR_WIDGET_LIGHT_SHADOW);
