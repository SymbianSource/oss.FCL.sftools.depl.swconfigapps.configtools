...
public class WidgetOptions {
	...
	public WidgetOptions(Set<WidgetOption> options, SettingType type) {
	...
	private class WidgetOptionComparator implements Comparator<WidgetOption> {
		...
		public WidgetOptionComparator(SettingType type) {
			this.type = type;
		}
		...
		public int compare(WidgetOption o1, WidgetOption o2) {
			...
			try {
				if (type == null || type == SettingType.STRING) {
					return value1.compareTo(o2.getKey());
