 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getLastSavedValue <em>Last Saved Value</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getLength <em>Length</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getTotalDigits <em>Total Digits</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMaxExclusive <em>Max Exclusive</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#isContainedInLastLayer <em>Contained In Last Layer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#isLastSavedInLastLayer <em>Last Saved In Last Layer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SimpleSettingImpl#getChoosenOption <em>Choosen Option</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleSettingImpl extends SettingImpl implements SimpleSetting {
				...
				if (optionValues != null) {
					for (String optionKey : optionValues.keySet()) {
						if (newValue.equals(optionValues.get(optionKey).getValue2Save())) {
							setChoosenOption(optionKey);//opt.getOptionValues().
							// get
							// (
							// newValue);
							break;
	...
	public void setPattern(String newPattern) {
		...
		pattern = newPattern;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfmlPackage.SIMPLE_SETTING__PATTERN, oldPattern, pattern));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConfmlPackage.SIMPLE_SETTING__CHOOSEN_OPTION:
