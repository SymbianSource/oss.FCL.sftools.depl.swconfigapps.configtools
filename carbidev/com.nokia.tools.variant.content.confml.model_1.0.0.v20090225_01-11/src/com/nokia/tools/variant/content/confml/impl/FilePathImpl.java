 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getPath <em>Path</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getLastSavedPath <em>Last Saved Path</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getDefaultPath <em>Default Path</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#isPathReadOnly <em>Path Read Only</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getPathNameOverride <em>Path Name Override</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getPathDescriptionOverride <em>Path Description Override</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#isContainedInLastLayer <em>Contained In Last Layer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.FilePathImpl#isLastSavedInLastLayer <em>Last Saved In Last Layer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilePathImpl extends FileSystemEntrySettingImpl implements FilePath {
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfmlPackage.FILE_PATH__PATH, oldPath, path));
	}
