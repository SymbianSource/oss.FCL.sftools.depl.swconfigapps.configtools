 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getAbsRef <em>Abs Ref</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getLeafGroup <em>Leaf Group</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getType <em>Type</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isRfsValue <em>Rfs Value</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getFeatureName <em>Feature Name</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getNote <em>Note</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isComputedRelevant <em>Computed Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isComputedConstraint <em>Computed Constraint</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#isValueNull <em>Value Null</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getNameOverride <em>Name Override</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getDescriptionOverride <em>Description Override</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getOption <em>Option</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getParentGroup <em>Parent Group</em>}</li>
 *   <li>{@link com.nokia.tools.variant.content.confml.impl.SettingImpl#getOptionDependencies <em>Option Dependencies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SettingImpl extends EObjectImpl implements Setting {
	...
	public boolean isVisible() {
		...
		if (getLeafGroup().size() > 0 || getParentGroup().size() > 0) {
			return true;
		}
