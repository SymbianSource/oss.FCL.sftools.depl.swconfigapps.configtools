 ...
 * <ul>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getDescription
 * <em>Description</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getIconDescriptor
 * <em>Icon Descriptor</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getIconTitle
 * <em>Icon Title</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getIconURI
 * <em>Icon URI</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getSettings
 * <em>Settings</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getRelevant
 * <em>Relevant</em>}</li>
 * <li>
 * {@link com.nokia.tools.variant.confml.core.model.application.impl.EAppFeatureImpl#getRef
 * <em>Ref</em>}</li>
 * </ul>
 * </p>
 * 
...
public class EAppFeatureImpl extends EObjectImpl implements EAppFeature {
    ...
    /**
     * The default value of the '{@link #getIconDescriptor()
     * <em>Icon Descriptor</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getIconDescriptor()
     * <em>Icon Descriptor</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getIconDescriptor()
    ...
    /**
     * The default value of the '{@link #getIconTitle() <em>Icon Title</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getIconTitle()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getIconTitle() <em>Icon Title</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getIconTitle()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getRelevant() <em>Relevant</em>}'
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__DESCRIPTION,
    ...
    public void setIconDescriptor(Object newIconDescriptor) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__ICON_DESCRIPTOR,
                    oldIconDescriptor, iconDescriptor));
    }
    ...
    public void setIconTitle(String newIconTitle) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__ICON_TITLE, oldIconTitle,
                    iconTitle));
    }
    ...
    public void setIconURI(URI newIconURI) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__ICON_URI, oldIconURI,
                    iconURI));
    }
    ...
    public EMap<String, EAppSetting> getSettings() {
        if (settings == null) {
            settings = new EcoreEMap<String, EAppSetting>(
                    EApplicationPackage.Literals.EAPP_SETTING_ENTRY,
                    EAppSettingEntryImpl.class, this,
                    EApplicationPackage.EAPP_FEATURE__SETTINGS);
        }
        return settings;
    }
    ...
    public NotificationChain basicSetRelevant(EAppExpression newRelevant,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this,
                    Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__RELEVANT, oldRelevant,
                    newRelevant);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setRelevant(EAppExpression newRelevant) {
        if (newRelevant != relevant) {
            ...
            if (relevant != null)
                msgs = ((InternalEObject) relevant).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE
                                - EApplicationPackage.EAPP_FEATURE__RELEVANT,
                        null, msgs);
            if (newRelevant != null)
                msgs = ((InternalEObject) newRelevant).eInverseAdd(this,
                        EOPPOSITE_FEATURE_BASE
                                - EApplicationPackage.EAPP_FEATURE__RELEVANT,
                        null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__RELEVANT, newRelevant,
                    newRelevant));
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    EApplicationPackage.EAPP_FEATURE__NAME, oldName, name));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case EApplicationPackage.EAPP_FEATURE__ICON_DESCRIPTOR:
            return ICON_DESCRIPTOR_EDEFAULT == null ? iconDescriptor != null
                    : !ICON_DESCRIPTOR_EDEFAULT.equals(iconDescriptor);
        case EApplicationPackage.EAPP_FEATURE__ICON_TITLE:
            return ICON_TITLE_EDEFAULT == null ? iconTitle != null
                    : !ICON_TITLE_EDEFAULT.equals(iconTitle);
        case EApplicationPackage.EAPP_FEATURE__ICON_URI:
        ...
        case EApplicationPackage.EAPP_FEATURE__REF:
            return REF_EDEFAULT == null ? getRef() != null : !REF_EDEFAULT
                    .equals(getRef());
        }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == EAppIconContainer.class) {
            ...
            case EApplicationPackage.EAPP_FEATURE__ICON_DESCRIPTOR:
                return EApplicationPackage.EAPP_ICON_CONTAINER__ICON_DESCRIPTOR;
            case EApplicationPackage.EAPP_FEATURE__ICON_TITLE:
                return EApplicationPackage.EAPP_ICON_CONTAINER__ICON_TITLE;
            case EApplicationPackage.EAPP_FEATURE__ICON_URI:
                return EApplicationPackage.EAPP_ICON_CONTAINER__ICON_URI;
            default:
                return -1;
            }
        }
        if (baseClass == EAppNamedItem.class) {
            switch (derivedFeatureID) {
            case EApplicationPackage.EAPP_FEATURE__NAME:
                return EApplicationPackage.EAPP_NAMED_ITEM__NAME;
            default:
                return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == EAppIconContainer.class) {
            ...
            case EApplicationPackage.EAPP_ICON_CONTAINER__ICON_DESCRIPTOR:
                return EApplicationPackage.EAPP_FEATURE__ICON_DESCRIPTOR;
            case EApplicationPackage.EAPP_ICON_CONTAINER__ICON_TITLE:
                return EApplicationPackage.EAPP_FEATURE__ICON_TITLE;
            case EApplicationPackage.EAPP_ICON_CONTAINER__ICON_URI:
                return EApplicationPackage.EAPP_FEATURE__ICON_URI;
            default:
                return -1;
            }
        }
        if (baseClass == EAppNamedItem.class) {
            switch (baseFeatureID) {
            case EApplicationPackage.EAPP_NAMED_ITEM__NAME:
                return EApplicationPackage.EAPP_FEATURE__NAME;
            default:
                return -1;
            }
        }
