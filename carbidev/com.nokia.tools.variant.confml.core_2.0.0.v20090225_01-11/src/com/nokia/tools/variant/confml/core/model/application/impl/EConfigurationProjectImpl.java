 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getDate <em>Date</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getEditor <em>Editor</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getPlatform <em>Platform</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getRelease <em>Release</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getMetaId <em>Meta Id</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getLayers <em>Layers</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getLastLayer <em>Last Layer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getRootConfml <em>Root Confml</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getStorage <em>Storage</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getConfVersion <em>Conf Version</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfigurationProjectImpl#getDefaultView <em>Default View</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
