 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EAppSequenceDataItemImpl#getSubSettings <em>Sub Settings</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EAppSequenceDataItemImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ESourceLocator.class) {
            switch (derivedFeatureID) {
                case EApplicationPackage.EAPP_SEQUENCE_DATA_ITEM__URI: return EConfmlRootPackage.ESOURCE_LOCATOR__URI;
                default: return -1;
            }
        }
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ESourceLocator.class) {
            switch (baseFeatureID) {
                case EConfmlRootPackage.ESOURCE_LOCATOR__URI: return EApplicationPackage.EAPP_SEQUENCE_DATA_ITEM__URI;
                default: return -1;
            }
        }
