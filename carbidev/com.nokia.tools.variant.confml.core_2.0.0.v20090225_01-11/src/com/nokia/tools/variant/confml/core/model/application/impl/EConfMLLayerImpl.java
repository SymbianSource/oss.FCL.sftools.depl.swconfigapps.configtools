 ...
 * <ul>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getDate <em>Date</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getEditor <em>Editor</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getPlatform <em>Platform</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getRelease <em>Release</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getOrigin <em>Origin</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getMetaId <em>Meta Id</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getViews <em>Views</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getResourceMap <em>Resource Map</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getDocumentMap <em>Document Map</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getImplMap <em>Impl Map</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getLayerFiles <em>Layer Files</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getRootConfml <em>Root Confml</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getLayerURI <em>Layer URI</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.variant.confml.core.model.application.impl.EConfMLLayerImpl#getIncludes <em>Includes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
