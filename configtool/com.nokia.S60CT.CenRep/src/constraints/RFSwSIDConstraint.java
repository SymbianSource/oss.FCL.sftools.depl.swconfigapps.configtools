...
public class RFSwSIDConstraint extends AbstractModelConstraint {
	...
	private static final String URL_POSTFIX = "#.7B.25element_ref.25.7D_has_RFS_defined.2C_but_write_capability_is_restricted_with_SID";
	...
	public IStatus validate(IValidationContext ctx) {
		...
		if(IAccessable.class.isInstance(obj)&&RVG.class.isInstance(obj)){
			if(((RVG)obj).isRfs()){
				...
				if(wAccess!=null&&wAccess.getSid()!=null&&!wAccess.getSid().trim().isEmpty())
