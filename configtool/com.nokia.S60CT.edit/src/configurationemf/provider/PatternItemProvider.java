...
/**
 * This is the item provider adapter for a {@link configurationemf.Pattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PatternItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Pattern_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Pattern_value_feature", "_UI_Pattern_type"),
				 ConfigurationemfPackage.Literals.PATTERN__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Pattern)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pattern.class)) {
			case ConfigurationemfPackage.PATTERN__VALUE:
