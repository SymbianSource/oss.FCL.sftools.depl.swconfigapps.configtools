...
/**
 * This is the item provider adapter for a {@link configurationemf.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationemfPackage.Literals.VIEW__NAME,
				 true,
				 false,
				 false,
	...
	protected void addReadOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_readOnly_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_readOnly_feature", "_UI_View_type"),
				 ConfigurationemfPackage.Literals.VIEW__READ_ONLY,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationemfPackage.Literals.VIEW__META);
			childrenFeatures.add(ConfigurationemfPackage.Literals.VIEW__PARENT_GROUP);
			childrenFeatures.add(ConfigurationemfPackage.Literals.VIEW__LINK);
			childrenFeatures.add(ConfigurationemfPackage.Literals.VIEW__ICON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.VIEW__META,
				 ConfigurationemfFactory.eINSTANCE.createMeta()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.VIEW__PARENT_GROUP,
				 ConfigurationemfFactory.eINSTANCE.createParentGroup()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.VIEW__LINK,
				 ConfigurationemfFactory.eINSTANCE.createLink()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.VIEW__ICON,
