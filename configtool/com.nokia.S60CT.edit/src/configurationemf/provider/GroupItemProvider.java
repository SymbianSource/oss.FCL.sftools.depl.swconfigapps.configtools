...
/**
 * This is the item provider adapter for a {@link configurationemf.Group} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
...
//			addNamePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationemfPackage.Literals.GROUP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addReadOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Group_readOnly_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Group_readOnly_feature", "_UI_Group_type"),
				 ConfigurationemfPackage.Literals.GROUP__READ_ONLY,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationemfPackage.Literals.GROUP__GSETTING);
			childrenFeatures.add(ConfigurationemfPackage.Literals.GROUP__ICON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.GROUP__GSETTING,
				 ConfigurationemfFactory.eINSTANCE.createGSetting()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.GROUP__ICON,
