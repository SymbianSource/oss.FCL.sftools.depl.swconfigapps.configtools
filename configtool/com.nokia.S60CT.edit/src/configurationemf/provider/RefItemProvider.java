...
/**
 * This is the item provider adapter for a {@link configurationemf.Ref} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RefItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfigurationemfPackage.Literals.REF__NAME,
				 true,
				 false,
				 false,
	...
	protected void addReferablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ref_referable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ref_referable_feature", "_UI_Ref_type"),
				 ConfigurationemfPackage.Literals.REF__REFERABLE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ref_template_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ref_template_feature", "_UI_Ref_type"),
				 ConfigurationemfPackage.Literals.REF__TEMPLATE,
				 true,
				 false,
				 false,
	...
	protected void addExtensionPolicyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ref_extensionPolicy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ref_extensionPolicy_feature", "_UI_Ref_type"),
				 ConfigurationemfPackage.Literals.REF__EXTENSION_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEmptyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ref_empty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ref_empty_feature", "_UI_Ref_type"),
				 ConfigurationemfPackage.Literals.REF__EMPTY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfigurationemfPackage.Literals.REF__REF);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigurationemfPackage.Literals.REF__REF,
