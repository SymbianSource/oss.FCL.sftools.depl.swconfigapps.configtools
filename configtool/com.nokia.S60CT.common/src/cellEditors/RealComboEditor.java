...
public class RealComboEditor extends ComboBoxCellEditor implements IPairItem{
	
	Map pairs = null;
	public RealComboEditor() {
		// Auto-generated constructor stub
	}

	public RealComboEditor(Composite parent, String[] items) {
		super(parent, items);
		// Auto-generated constructor stub
	}

	public RealComboEditor(Composite parent, String[] items, int style) {
