...
public class AddConfigurationViewAction extends AddChildAction {

	EReference childReference = ConfigurationemfPackage.eINSTANCE.getConfiguration_View();
	EClass childClass = ConfigurationemfPackage.eINSTANCE.getView();
	EAttribute roAttribute = ConfigurationemfPackage.eINSTANCE.getConfiguration_ReadOnly();
	
	public AddConfigurationViewAction() {
