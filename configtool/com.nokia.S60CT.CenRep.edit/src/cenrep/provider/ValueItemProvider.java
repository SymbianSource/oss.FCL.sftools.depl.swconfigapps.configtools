...
/**
 * This is the item provider adapter for a {@link cenrep.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider
	...
	public final static Value ZERO_VALUE = CenrepFactory.eINSTANCE.createValue(); 
	...
	public List getPropertyDescriptors(Object object) {
		if(object.equals(ZERO_VALUE))return null;
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_val_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_val_feature", "_UI_Value_type"),
				 CenrepPackage.Literals.VALUE__VAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CenrepPackage.Literals.VALUE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Value.class)) {
			case CenrepPackage.VALUE__VAL:
			case CenrepPackage.VALUE__ID:
