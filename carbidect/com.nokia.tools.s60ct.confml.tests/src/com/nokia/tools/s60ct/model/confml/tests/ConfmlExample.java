...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>confml</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfmlExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ConfmlPackage.eNS_URI, 
			 ConfmlPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.confml"));
				EFeature root = ConfmlFactory.eINSTANCE.createEFeature();
