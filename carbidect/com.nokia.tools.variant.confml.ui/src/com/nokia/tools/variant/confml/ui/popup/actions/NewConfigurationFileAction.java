...
import com.nokia.tools.variant.confml.ui.wizards.NewConfMLWizard;

public class NewConfigurationFileAction implements 
	...
	public void run(IAction action) {
		...
		NewConfMLWizard newConfMLWizard = new NewConfMLWizard();
		newConfMLWizard.init(workbench, ss);

		WizardDialog dialog = new WizardDialog(shell, newConfMLWizard);
		dialog.create();
		dialog.open();
	}
