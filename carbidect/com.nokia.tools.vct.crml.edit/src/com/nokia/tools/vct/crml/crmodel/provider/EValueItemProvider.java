...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.vct.crml.crmodel.EValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EValue_val_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EValue_val_feature", "_UI_EValue_type"),
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EValue_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EValue_id_feature", "_UI_EValue_type"),
	...
	public String getText(Object object) {
		String label = ((EValue)object).getId();
