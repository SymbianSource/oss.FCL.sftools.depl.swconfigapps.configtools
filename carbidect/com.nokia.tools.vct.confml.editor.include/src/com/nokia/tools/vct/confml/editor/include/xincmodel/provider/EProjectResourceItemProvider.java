...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.vct.confml.editor.include.xincmodel.EProjectResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EProjectResourceItemProvider
	 ...
	 * @generated
	 */
	public EProjectResourceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EProjectResource_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EProjectResource_name_feature", "_UI_EProjectResource_type"),
				 EXincModelPackage.Literals.EPROJECT_RESOURCE__NAME,
				 false,
				 false,
				 false,
	...
	protected void addProjectPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EProjectResource_projectPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EProjectResource_projectPath_feature", "_UI_EProjectResource_type"),
				 EXincModelPackage.Literals.EPROJECT_RESOURCE__PROJECT_PATH,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((EProjectResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EProjectResource_type") :
			getString("_UI_EProjectResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EProjectResource.class)) {
