...
import com.nokia.tools.vct.confml.model.metaext.util.EMetaExtResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>metaext</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EMetaExtExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap()
				.put(Resource.Factory.Registry.DEFAULT_EXTENSION,
						new EMetaExtResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(EMetaExtPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.emetaext"));
				EConfigurationPropertyElement root = EMetaExtFactory.eINSTANCE
