...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>xsd</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EXSDFacetExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(EXSDFacetPackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.exsdfacet"));
				EMinInclusive root = EXSDFacetFactory.eINSTANCE
						.createEMinInclusive();
