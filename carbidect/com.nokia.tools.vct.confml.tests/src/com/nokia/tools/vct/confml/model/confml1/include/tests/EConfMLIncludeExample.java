...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>include</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EConfMLIncludeExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(EConfMLIncludePackage.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My."));
				EInclude root = EConfMLIncludeFactory.eINSTANCE
						.createEInclude();
