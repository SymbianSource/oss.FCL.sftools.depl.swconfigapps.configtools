...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>confml2</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class EConfML2Example {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getContentTypeToFactoryMap()
				.put(EConfML2Package.eCONTENT_TYPE,
						new EConfML2ResourceFactoryImpl());
		...
		resourceSet.getURIConverter().getContentHandlers().add(
				new RootXMLContentHandlerImpl(EConfML2Package.eCONTENT_TYPE,
						null, null, EConfML2Package.eNS_URI, null));

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put(EConfML2Package.eNS_URI,
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						...
						EConfML2Package.eCONTENT_TYPE);
				EConfML2Document documentRoot = EConfML2Factory.eINSTANCE
						.createEConfML2Document();
				EConfigurationElement root = EConfML2Factory.eINSTANCE
