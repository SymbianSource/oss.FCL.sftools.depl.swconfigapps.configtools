...
public final class ModelSearchQuery extends EcoreModelSearchQuery {
	public final static String IBYMLModel_MODEL_SEARCH_IMAGE_PATH = "icons/esearch.gif"; //$NON-NLS-1$
	public final static String IBYMLModel_MODEL_SEARCH_RESULT_IMAGE_PATH = "icons/esearch.gif"; //$NON-NLS-1$

	final static class IBYMLModelSupportedElements {
		private static List<EClassifier> getIBYMLModelEClassifiersLiterals() {
			List<EClassifier> eclassifiersLiteralsList = new ArrayList<EClassifier>();

			try {

				for (Object o : EIBYModelPackage.eINSTANCE.getEClassifiers()) {
				...
				Activator
						...
						.log(
								new Status(
										...
										0,
										Messages
												.getString("ModelSearchQuery.IBYMLModelClassifiersWalkErrorMessage"), t)); //$NON-NLS-1$
			}
		...
		public static List<EClassifier> getSupportedElements(
			...
			for (EClassifier eClass : getIBYMLModelEClassifiersLiterals()) {
	...
	public String getQueryImagePath() {
		return IBYMLModel_MODEL_SEARCH_IMAGE_PATH;
	}

	@Override
	public String getResultImagePath() {
		return IBYMLModel_MODEL_SEARCH_RESULT_IMAGE_PATH;
	}
	...
	public String getName() {
		...
		case NORMAL_TEXT:
			return Messages
					.getString("IBYMLModelModelSearchQuery.NormalTextMessage"); //$NON-NLS-1$
		case CASE_SENSITIVE:
			return Messages
					.getString("IBYMLModelModelSearchQuery.CaseSensitiveMessage"); //$NON-NLS-1$
		case REGULAR_EXPRESSION:
			return Messages
					.getString("IBYMLModelModelSearchQuery.RegularExpressionMessage"); //$NON-NLS-1$
		}

		return Messages
				.getString("IBYMLModelModelSearchQuery.DefaultSearchKindMessage"); //$NON-NLS-1$
	}
}
