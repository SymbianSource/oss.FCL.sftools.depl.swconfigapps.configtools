...

{
	...
	public IModelSearchQuery buildGlobalTextualibymodelModelSearchQuery(
			String expr, IModelSearchScope<Object, Resource> scope) {
		return buildTextualModelSearchQuery(expr,
				com.nokia.tools.vct.ibyml.ibymodel.EIBYModelPackage.eINSTANCE
						.getEClassifiers(),
				ModelSearchQueryTextualExpressionEnum.NORMAL_TEXT, scope,
				"http://www.s60.com/xml/iby/1" //$NON-NLS-1$
		);
	}

	public IModelSearchQuery buildGlobalRegexibymodelModelSearchQuery(
			String expr, IModelSearchScope<Object, Resource> scope) {
		return buildTextualModelSearchQuery(expr,
				com.nokia.tools.vct.ibyml.ibymodel.EIBYModelPackage.eINSTANCE
						.getEClassifiers(),
				ModelSearchQueryTextualExpressionEnum.REGULAR_EXPRESSION,
				scope, "http://www.s60.com/xml/iby/1" //$NON-NLS-1$
		);
	}

	public IModelSearchQuery buildGlobalCaseSensitiveibymodelModelSearchQuery(
			String expr, IModelSearchScope<Object, Resource> scope) {
		return buildTextualModelSearchQuery(expr,
				com.nokia.tools.vct.ibyml.ibymodel.EIBYModelPackage.eINSTANCE
						.getEClassifiers(),
	...
	public IModelSearchQuery buildGlobalTextualModelSearchQuery(String pattern,
		...
		if (nsURI.equals("http://www.s60.com/xml/iby/1")) { //$NON-NLS-1$
			return buildGlobalTextualibymodelModelSearchQuery(pattern, scope);
		}
	...
	public IModelSearchQuery buildGlobalRegexModelSearchQuery(String pattern,
		...
		if (nsURI.equals("http://www.s60.com/xml/iby/1")) { //$NON-NLS-1$
			return buildGlobalRegexibymodelModelSearchQuery(pattern, scope);
		}
	...
	public IModelSearchQuery buildGlobalCaseSensitiveModelSearchQuery(
		...
		if (nsURI.equals("http://www.s60.com/xml/iby/1")) { //$NON-NLS-1$
			return buildGlobalCaseSensitiveibymodelModelSearchQuery(pattern,
					scope);
		}
