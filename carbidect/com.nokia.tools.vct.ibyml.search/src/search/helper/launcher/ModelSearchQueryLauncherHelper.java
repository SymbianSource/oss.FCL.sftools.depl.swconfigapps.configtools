...

{
	...
	public IModelSearchResult launchGlobalTextualibymodelModelSearchQuery(
	...
	public IModelSearchResult launchGlobalRegexibymodelModelSearchQuery(
			String pattern, IModelSearchScope<Object, Resource> scope) {
		IModelSearchQuery q = buildTextualModelSearchQuery(pattern,
				com.nokia.tools.vct.ibyml.ibymodel.EIBYModelPackage.eINSTANCE
						.getEClassifiers(),
	...
	public IModelSearchResult launchGlobalCaseSensitiveibymodelModelSearchQuery(
			String pattern, IModelSearchScope<Object, Resource> scope) {
		IModelSearchQuery q = buildTextualModelSearchQuery(pattern,
				com.nokia.tools.vct.ibyml.ibymodel.EIBYModelPackage.eINSTANCE
						.getEClassifiers(),
