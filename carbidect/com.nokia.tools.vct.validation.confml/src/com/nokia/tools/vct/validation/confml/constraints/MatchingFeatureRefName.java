...
public class MatchingFeatureRefName extends AbstractModelConstraint {

	public MatchingFeatureRefName() {
		super();
	}
	...
	public IStatus validate(IValidationContext ctx) {
		if (ctx.getTarget() instanceof EFeatureElement) {
			...
			if (featureElement.getRef() == null
					|| featureElement.getName() == null) {
				return ctx.createSuccessStatus();
			}

			if (featureElement.getRef().equalsIgnoreCase(
