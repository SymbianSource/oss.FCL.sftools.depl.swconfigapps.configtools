...
public class DuplicateFeatureRef extends AbstractModelConstraint {

	public DuplicateFeatureRef() {
		super();
	}
	...
	public IStatus validate(IValidationContext ctx) {
		...
		if (ctx.getTarget() instanceof EFeatureElement) {
			...
			absRef = featureElement.getRef();
		} else if (ctx.getTarget() instanceof com.nokia.tools.vct.confml.model.confml2.EFeatureElement) {
			com.nokia.tools.vct.confml.model.confml2.EFeatureElement featureElement = (com.nokia.tools.vct.confml.model.confml2.EFeatureElement) ctx.getTarget();
			absRef = featureElement.getRef();
	...
	private Set<String> getDuplicateContext(IValidationContext ctx) {
		...
		while (it.hasNext()) {
			...
			if (o instanceof com.nokia.tools.vct.confml.model.confml2.EFeatureElement) {
				populateMap(
						map,
