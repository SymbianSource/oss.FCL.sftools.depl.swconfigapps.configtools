...
public class IntegerTextBox extends BaseTextBox {
	...
	public IntegerTextBox(Composite parent, int style, String widgetLabel,WidgetOptions options, Image image) {
	...
	protected void buildMainControl() {
		...
		//controls.setBackground(new Color(group.getDisplay(), 10, 100, 0));
