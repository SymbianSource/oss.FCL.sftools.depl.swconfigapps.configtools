 ...
 * into them.
 */
public class FolderTextBox extends BaseConfMLWidget {

	protected Text text;
//	protected Button button;
	
	public FolderTextBox(Composite parent, int style, String widgetLabel) {
		super(parent, style, widgetLabel);
	}
	
	public FolderTextBox(Composite parent, int style, String widgetLabel,WidgetOptions options, Image image) {
...
//				DirectoryDialog dialog = new DirectoryDialog(group.getShell(), SWT.MULTI);
//				String newText = dialog.open();
//				if (newText != null) text.setText(newText);
//			}
//			
//		});
