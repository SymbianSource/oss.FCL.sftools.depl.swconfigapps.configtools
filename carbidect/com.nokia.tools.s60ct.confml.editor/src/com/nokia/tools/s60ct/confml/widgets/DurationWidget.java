...
public class DurationWidget extends BaseConfMLWidget {
	...
	public DurationWidget(Composite parent, int style, String widgetLabel,WidgetOptions options, Image image) {
	...
	private boolean isNotDisposedOrNull() {
		if (yearText != null && !yearText.isDisposed() && monthText != null
				&& !monthText.isDisposed() && dayText != null
				&& !dayText.isDisposed() && hourText != null
				&& !hourText.isDisposed() && minuteText != null
				&& !minuteText.isDisposed() && secondText != null
				&& !secondText.isDisposed()) {
			return true;
		}
		return false;
	}
	...
	public void setGrayed(boolean grayed) {
		...
		yearText.setEnabled(!grayed);
		monthText.setEnabled(!grayed);
		dayText.setEnabled(!grayed);
		hourText.setEnabled(!grayed);
		minuteText.setEnabled(!grayed);
		secondText.setEnabled(!grayed);
		
		if (grayed)
		{
			yearText.setForeground(yearText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			monthText.setForeground(monthText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			dayText.setForeground(dayText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			hourText.setForeground(hourText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			hourText.setForeground(hourText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			minuteText.setForeground(minuteText.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			firstSeparationLabel.setForeground(firstSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			secondSeparationLabel.setForeground(secondSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			thirdSeparationLabel.setForeground(thirdSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			fourthSeparationLabel.setForeground(fourthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			fifthSeparationLabel.setForeground(fifthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			sixthSeparationLabel.setForeground(sixthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_GRAY));
			label.setForeground(label.getDisplay().getSystemColor(SWT.COLOR_GRAY));
		}
		else
		{
			yearText.setForeground(yearText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			monthText.setForeground(monthText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			dayText.setForeground(dayText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			hourText.setForeground(hourText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			hourText.setForeground(hourText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			minuteText.setForeground(minuteText.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			firstSeparationLabel.setForeground(firstSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			secondSeparationLabel.setForeground(secondSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			thirdSeparationLabel.setForeground(thirdSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			fourthSeparationLabel.setForeground(fourthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			fifthSeparationLabel.setForeground(fifthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
			sixthSeparationLabel.setForeground(sixthSeparationLabel.getDisplay().getSystemColor(SWT.COLOR_BLACK));
