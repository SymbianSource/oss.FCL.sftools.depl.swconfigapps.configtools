 ...
 */
public class JavaVersionCheckerTest extends TestCase {
	...
	static final String SUPPORTED_SUN_VERSION = SupportedJavaVersions.versionSun15012b04;
	...
	public void testIsCurrentJreSupported() throws Exception {
		...
		if (version.equals(SupportedJavaVersions.versionSun15012b04) && vendor.equals(SupportedJavaVersions.vendorSun)){
