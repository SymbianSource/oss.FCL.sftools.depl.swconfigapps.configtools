...
public class ConfXMLHelperImpl extends XMLHelperImpl {
	...
	public EStructuralFeature getFeature(EClass eClass, String namespaceURI, String name, boolean isElement) {
		...
		} else if(eClass.isInstance(scope.getESettingRfsContainer())) {
			return scope.getESettingRfsContainer_Settings();
		}

		if(eClass.isInstance(scope2.getESettingDataContainer())) {
			return scope2.getESettingDataContainer_Settings();
		} else if(eClass.isInstance(scope2.getESettingRfsContainer())) {
			return scope2.getESettingRfsContainer_Settings();
		}
