 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getIncludes <em>Includes</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getSettings <em>Settings</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.EGroupImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EGroupImpl extends ECommonAttrsImpl implements EGroup {
	...
	protected EClass eStaticClass() {
		return EConfML2Package.Literals.EGROUP;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML2Package.EGROUP__CONTENTS);
		}
		return contents;
	}
	...
	public EList<EInclude> getIncludes() {
		return getContents().list(
				EConfML2Package.Literals.EGROUP_CONTAINER__INCLUDES);
	}
	...
	public EList<ESettingElement> getSettings() {
		return getContents().list(EConfML2Package.Literals.EGROUP__SETTINGS);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.EGROUP__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case EConfML2Package.EGROUP__CONTENTS:
			return ((InternalEList<?>) getContents()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.EGROUP__LINKS:
			return ((InternalEList<?>) getLinks()).basicRemove(otherEnd, msgs);
		case EConfML2Package.EGROUP__DESCRIPTIONS:
			return ((InternalEList<?>) getDescriptions()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.EGROUP__ICONS:
			return ((InternalEList<?>) getIcons()).basicRemove(otherEnd, msgs);
		case EConfML2Package.EGROUP__GROUPS:
			return ((InternalEList<?>) getGroups()).basicRemove(otherEnd, msgs);
		case EConfML2Package.EGROUP__INCLUDES:
			return ((InternalEList<?>) getIncludes()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.EGROUP__SETTINGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EConfML2Package.EGROUP__SETTINGS:
			return getSettings();
		case EConfML2Package.EGROUP__NAME:
			return getName();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EGroupContainer.class) {
			...
			case EConfML2Package.EGROUP__INCLUDES:
				return EConfML2Package.EGROUP_CONTAINER__INCLUDES;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EContents.class) {
			...
			case EConfML2Package.ECONTENTS__CONTENTS:
				return EConfML2Package.EGROUP__CONTENTS;
			default:
				return -1;
			}
		}
		if (baseClass == ELinkContainer.class) {
			...
			case EConfML2Package.ELINK_CONTAINER__LINKS:
				return EConfML2Package.EGROUP__LINKS;
			default:
				return -1;
			}
		}
		if (baseClass == EDescriptionContainer.class) {
			...
			case EConfML2Package.EDESCRIPTION_CONTAINER__DESCRIPTIONS:
				return EConfML2Package.EGROUP__DESCRIPTIONS;
			default:
				return -1;
			}
		}
		if (baseClass == EIconContainer.class) {
			...
			case EConfML2Package.EICON_CONTAINER__ICONS:
				return EConfML2Package.EGROUP__ICONS;
			default:
				return -1;
			}
		}
		if (baseClass == EGroupContainer.class) {
			...
			case EConfML2Package.EGROUP_CONTAINER__GROUPS:
				return EConfML2Package.EGROUP__GROUPS;
			case EConfML2Package.EGROUP_CONTAINER__INCLUDES:
				return EConfML2Package.EGROUP__INCLUDES;
			default:
				return -1;
			}
		}
