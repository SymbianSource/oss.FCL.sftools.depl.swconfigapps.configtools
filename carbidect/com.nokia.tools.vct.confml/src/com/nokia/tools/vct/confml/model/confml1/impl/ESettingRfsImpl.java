 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.ESettingRfsImpl#getSettings <em>Settings</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.ESettingRfsImpl#getRfs <em>Rfs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ESettingRfsImpl extends ERefNamedElementImpl implements
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.ESETTING_RFS;
	}
	...
	public EList<ESettingRfs> getSettings() {
		if (settings == null) {
			settings = new EObjectContainmentEList<ESettingRfs>(
					...
					EConfML1Package.ESETTING_RFS__SETTINGS);
		}
		return settings;
	}
	...
	public void setRfs(String newRfs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.ESETTING_RFS__RFS, oldRfs, rfs));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ESettingRfsContainer.class) {
			...
			case EConfML1Package.ESETTING_RFS__SETTINGS:
				return EConfML1Package.ESETTING_RFS_CONTAINER__SETTINGS;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ESettingRfsContainer.class) {
			...
			case EConfML1Package.ESETTING_RFS_CONTAINER__SETTINGS:
				return EConfML1Package.ESETTING_RFS__SETTINGS;
			default:
				return -1;
			}
		}
