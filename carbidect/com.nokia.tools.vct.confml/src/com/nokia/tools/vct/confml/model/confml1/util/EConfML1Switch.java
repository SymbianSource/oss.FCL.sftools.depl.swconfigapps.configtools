...
public class EConfML1Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EConfML1Package.EFEATURE_RFS: {
			...
			if (result == null)
				result = caseESettingRfsContainer(eFeatureRfs);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case EConfML1Package.ESETTING_RFS: {
			...
			if (result == null)
				result = caseESettingRfsContainer(eSettingRfs);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case EConfML1Package.EOPTION_ELEMENT: {
			...
			if (result == null)
				result = caseEIconContainer(eOptionElement);
			if (result == null)
		...
		case EConfML1Package.EPROPERTY_ELEMENT: {
			...
			if (result == null)
				result = caseEIconContainer(ePropertyElement);
			if (result == null)
		...
		case EConfML1Package.ESETTING_RFS_CONTAINER: {
			ESettingRfsContainer eSettingRfsContainer = (ESettingRfsContainer) theEObject;
			T result = caseESettingRfsContainer(eSettingRfsContainer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ESetting Rfs Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>ESetting Rfs Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseESettingRfsContainer(ESettingRfsContainer object) {
		return null;
	}
