 ...
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EGroupImpl#getIncludes <em>Includes</em>}</li>
...
public class EGroupImpl extends ECommonAttrsImpl implements EGroup {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case EConfML1Package.EGROUP__INCLUDES:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EGroupContainer.class) {
			...
			case EConfML1Package.EGROUP_CONTAINER__INCLUDES:
				return EConfML1Package.EGROUP__INCLUDES;
			default:
				return -1;
			}
		}
