 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getIncludes <em>Includes</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getMetas <em>Metas</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EViewElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EViewElementImpl extends ECommonAttrsImpl implements EViewElement {
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.EVIEW_ELEMENT;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML1Package.EVIEW_ELEMENT__CONTENTS);
		}
		return contents;
	}
	...
	public EList<EInclude> getIncludes() {
		return getContents().list(
				EConfML1Package.Literals.EGROUP_CONTAINER__INCLUDES);
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.EVIEW_ELEMENT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case EConfML1Package.EVIEW_ELEMENT__CONTENTS:
			return ((InternalEList<?>) getContents()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EVIEW_ELEMENT__LINKS:
			return ((InternalEList<?>) getLinks()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EVIEW_ELEMENT__DESCRIPTIONS:
			return ((InternalEList<?>) getDescriptions()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EVIEW_ELEMENT__ICONS:
			return ((InternalEList<?>) getIcons()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EVIEW_ELEMENT__GROUPS:
			return ((InternalEList<?>) getGroups()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EVIEW_ELEMENT__INCLUDES:
			return ((InternalEList<?>) getIncludes()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EVIEW_ELEMENT__METAS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case EConfML1Package.EVIEW_ELEMENT__METAS:
			return getMetas();
		case EConfML1Package.EVIEW_ELEMENT__NAME:
			return getName();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EGroupContainer.class) {
			...
			case EConfML1Package.EVIEW_ELEMENT__INCLUDES:
				return EConfML1Package.EGROUP_CONTAINER__INCLUDES;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EObject.class) {
			...
			case EConfML1Package.ECONTENTS__CONTENTS:
				return EConfML1Package.EVIEW_ELEMENT__CONTENTS;
			default:
				return -1;
			}
		}
		if (baseClass == ELinkContainer.class) {
			...
			case EConfML1Package.ELINK_CONTAINER__LINKS:
				return EConfML1Package.EVIEW_ELEMENT__LINKS;
			default:
				return -1;
			}
		}
		if (baseClass == EDescriptionContainer.class) {
			...
			case EConfML1Package.EDESCRIPTION_CONTAINER__DESCRIPTIONS:
				return EConfML1Package.EVIEW_ELEMENT__DESCRIPTIONS;
			default:
				return -1;
			}
		}
		if (baseClass == EIconContainer.class) {
			...
			case EConfML1Package.EICON_CONTAINER__ICONS:
				return EConfML1Package.EVIEW_ELEMENT__ICONS;
			default:
				return -1;
			}
		}
		if (baseClass == EGroupContainer.class) {
			...
			case EConfML1Package.EGROUP_CONTAINER__GROUPS:
				return EConfML1Package.EVIEW_ELEMENT__GROUPS;
			case EConfML1Package.EGROUP_CONTAINER__INCLUDES:
				return EConfML1Package.EVIEW_ELEMENT__INCLUDES;
			default:
				return -1;
			}
		}
		if (baseClass == EMetaContainer.class) {
			...
			case EConfML1Package.EMETA_CONTAINER__METAS:
				return EConfML1Package.EVIEW_ELEMENT__METAS;
			default:
				return -1;
			}
		}
