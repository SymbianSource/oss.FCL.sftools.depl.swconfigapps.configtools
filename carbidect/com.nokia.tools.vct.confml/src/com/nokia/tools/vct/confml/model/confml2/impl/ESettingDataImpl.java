 ...
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ESettingDataImpl#getRef <em>Ref</em>}</li>
 ...
 * @generated
 */
public class ESettingDataImpl extends EObjectImpl implements ESettingData {
	/**
	...
	public void setRef(String newRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.ESETTING_DATA__REF, oldRef, ref));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ERefNamedElement.class) {
			...
			case EConfML2Package.EREF_NAMED_ELEMENT__REF:
				return EConfML2Package.ESETTING_DATA__REF;
			default:
				return -1;
			}
		}
