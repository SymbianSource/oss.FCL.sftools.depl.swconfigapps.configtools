...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ETarget Path Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getReadOnly <em>Read Only</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getRequired <em>Required</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getMap <em>Map</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml2.impl.ETargetPathElementImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ETargetPathElementImpl extends ECommonAttrsImpl implements
		ETargetPathElement {
	/**
	 ...
	 * @generated
	 */
	protected ETargetPathElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EConfML2Package.Literals.ETARGET_PATH_ELEMENT;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML2Package.ETARGET_PATH_ELEMENT__CONTENTS);
		}
		return contents;
	}
	...
	public void setConstraint(String newConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.ETARGET_PATH_ELEMENT__CONSTRAINT,
	...
	public void setReadOnly(String newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.ETARGET_PATH_ELEMENT__READ_ONLY,
	...
	public void setRequired(String newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.ETARGET_PATH_ELEMENT__REQUIRED,
	...
	public void setMap(String newMap) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML2Package.ETARGET_PATH_ELEMENT__MAP, oldMap, map));
	}
	...
	public EList<EPattern> getPattern() {
		return getContents().list(
				EConfML2Package.Literals.ETARGET_PATH_ELEMENT__PATTERN);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case EConfML2Package.ETARGET_PATH_ELEMENT__CONTENTS:
			return ((InternalEList<?>) getContents()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.ETARGET_PATH_ELEMENT__DESCRIPTIONS:
			return ((InternalEList<?>) getDescriptions()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.ETARGET_PATH_ELEMENT__ICONS:
			return ((InternalEList<?>) getIcons()).basicRemove(otherEnd, msgs);
		case EConfML2Package.ETARGET_PATH_ELEMENT__LINKS:
			return ((InternalEList<?>) getLinks()).basicRemove(otherEnd, msgs);
		case EConfML2Package.ETARGET_PATH_ELEMENT__PATTERN:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EContents.class) {
			...
			case EConfML2Package.ECONTENTS__CONTENTS:
				return EConfML2Package.ETARGET_PATH_ELEMENT__CONTENTS;
			default:
				return -1;
			}
		}
		if (baseClass == EDescriptionContainer.class) {
			...
			case EConfML2Package.EDESCRIPTION_CONTAINER__DESCRIPTIONS:
				return EConfML2Package.ETARGET_PATH_ELEMENT__DESCRIPTIONS;
			default:
				return -1;
			}
		}
		if (baseClass == EIconContainer.class) {
			...
			case EConfML2Package.EICON_CONTAINER__ICONS:
				return EConfML2Package.ETARGET_PATH_ELEMENT__ICONS;
			default:
				return -1;
			}
		}
		if (baseClass == ELinkContainer.class) {
			...
			case EConfML2Package.ELINK_CONTAINER__LINKS:
				return EConfML2Package.ETARGET_PATH_ELEMENT__LINKS;
			default:
				return -1;
			}
		}
