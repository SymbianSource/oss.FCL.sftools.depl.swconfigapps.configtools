 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getDate <em>Date</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getEditor <em>Editor</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getProduct <em>Product</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getPlatform <em>Platform</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getRelease <em>Release</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getCustomer <em>Customer</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getConfigurationProperty <em>Configuration Property</em>}</li>
 *   <li>{@link com.nokia.tools.vct.confml.model.confml1.impl.EMetaElementImpl#getOtherElements <em>Other Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EMetaElementImpl extends EObjectImpl implements EMetaElement {
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.EMETA_ELEMENT;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML1Package.EMETA_ELEMENT__CONTENTS);
		}
		return contents;
	}
	...
	public EList<EMetaContent> getId() {
		return getContents().list(EConfML1Package.Literals.EMETA_ELEMENT__ID);
	}
	...
	public EList<EMetaContent> getDate() {
		return getContents().list(EConfML1Package.Literals.EMETA_ELEMENT__DATE);
	}
	...
	public EList<EMetaContent> getOwner() {
		return getContents()
				.list(EConfML1Package.Literals.EMETA_ELEMENT__OWNER);
	}
	...
	public EList<EMetaContent> getEditor() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__EDITOR);
	}
	...
	public EList<EMetaContent> getProduct() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__PRODUCT);
	}
	...
	public EList<EMetaContent> getStatus() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__STATUS);
	}
	...
	public EList<EMetaContent> getPlatform() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__PLATFORM);
	}
	...
	public EList<EMetaContent> getVersion() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__VERSION);
	}
	...
	public EList<EMetaContent> getRelease() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__RELEASE);
	}
	...
	public EList<EMetaContent> getCustomer() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__CUSTOMER);
	}
	...
	public EList<EConfigurationPropertyElement> getConfigurationProperty() {
		return getContents().list(
				EConfML1Package.Literals.EMETA_ELEMENT__CONFIGURATION_PROPERTY);
	}
	...
	public FeatureMap getOtherElements() {
		return (FeatureMap) getContents().<FeatureMap.Entry> list(
				EConfML1Package.Literals.EMETA_ELEMENT__OTHER_ELEMENTS);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case EConfML1Package.EMETA_ELEMENT__CONTENTS:
			return ((InternalEList<?>) getContents()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EMETA_ELEMENT__LINKS:
			return ((InternalEList<?>) getLinks()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__ICONS:
			return ((InternalEList<?>) getIcons()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__ID:
			return ((InternalEList<?>) getId()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__DATE:
			return ((InternalEList<?>) getDate()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__OWNER:
			return ((InternalEList<?>) getOwner()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__EDITOR:
			return ((InternalEList<?>) getEditor()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__PRODUCT:
			return ((InternalEList<?>) getProduct())
					.basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__STATUS:
			return ((InternalEList<?>) getStatus()).basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__PLATFORM:
			return ((InternalEList<?>) getPlatform()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EMETA_ELEMENT__VERSION:
			return ((InternalEList<?>) getVersion())
					.basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__RELEASE:
			return ((InternalEList<?>) getRelease())
					.basicRemove(otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__CUSTOMER:
			return ((InternalEList<?>) getCustomer()).basicRemove(otherEnd,
					msgs);
		case EConfML1Package.EMETA_ELEMENT__CONFIGURATION_PROPERTY:
			return ((InternalEList<?>) getConfigurationProperty()).basicRemove(
					otherEnd, msgs);
		case EConfML1Package.EMETA_ELEMENT__OTHER_ELEMENTS:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EIconContainer.class) {
			...
			case EConfML1Package.EICON_CONTAINER__ICONS:
				return EConfML1Package.EMETA_ELEMENT__ICONS;
			default:
				return -1;
			}
		}
