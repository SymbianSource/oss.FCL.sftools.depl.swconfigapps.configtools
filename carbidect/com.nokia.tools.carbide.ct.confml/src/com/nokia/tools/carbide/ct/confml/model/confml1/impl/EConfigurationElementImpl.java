...
import com.nokia.tools.carbide.ct.confml.model.confml1.EMetaContainer;
 ...
 * <ul>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getMetas <em>Metas</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getConfigurations <em>Configurations</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getViews <em>Views</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getData <em>Data</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getRfs <em>Rfs</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EConfigurationElementImpl#getIncludes <em>Includes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EConfigurationElementImpl extends ECommonAttrsImpl implements
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.ECONFIGURATION_ELEMENT;
	}
	...
	public FeatureMap getContents() {
		if (contents == null) {
			contents = new BasicFeatureMap(this,
					EConfML1Package.ECONFIGURATION_ELEMENT__CONTENTS);
		}
		return contents;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.ECONFIGURATION_ELEMENT__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.ECONFIGURATION_ELEMENT__VERSION,
					oldVersion, version));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EMetaContainer.class) {
			switch (derivedFeatureID) {
			case EConfML1Package.ECONFIGURATION_ELEMENT__METAS:
				return EConfML1Package.EMETA_CONTAINER__METAS;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EObject.class) {
			...
			case EConfML1Package.ECONTENTS__CONTENTS:
				return EConfML1Package.ECONFIGURATION_ELEMENT__CONTENTS;
			default:
				return -1;
			}
		}
		if (baseClass == ELinkContainer.class) {
			...
			case EConfML1Package.ELINK_CONTAINER__LINKS:
				return EConfML1Package.ECONFIGURATION_ELEMENT__LINKS;
			default:
				return -1;
			}
		}
		if (baseClass == EIconContainer.class) {
			...
			case EConfML1Package.EICON_CONTAINER__ICONS:
				return EConfML1Package.ECONFIGURATION_ELEMENT__ICONS;
			default:
				return -1;
			}
		}
		if (baseClass == EDescriptionContainer.class) {
			...
			case EConfML1Package.EDESCRIPTION_CONTAINER__DESCRIPTIONS:
				return EConfML1Package.ECONFIGURATION_ELEMENT__DESCRIPTIONS;
			default:
				return -1;
			}
		}
		if (baseClass == EMetaContainer.class) {
			switch (baseFeatureID) {
			case EConfML1Package.EMETA_CONTAINER__METAS:
				return EConfML1Package.ECONFIGURATION_ELEMENT__METAS;
			default:
				return -1;
			}
		}
