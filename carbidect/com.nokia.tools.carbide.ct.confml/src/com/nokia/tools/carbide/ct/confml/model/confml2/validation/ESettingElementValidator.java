...
/**
 * A sample validator interface for {@link com.nokia.tools.carbide.ct.confml.model.confml2.ESettingElement}.
...
public interface ESettingElementValidator {
	...
	boolean validateLocalPath(ELocalPathElement value);

	boolean validateTargetPath(ETargetPathElement value);
}
