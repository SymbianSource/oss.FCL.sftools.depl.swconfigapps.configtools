 ...
 * <ul>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EIconElementImpl#getHref <em>Href</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EIconElementImpl#getTitle <em>Title</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EIconElementImpl extends ECommonAttrsImpl implements EIconElement {
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.EICON_ELEMENT;
	}
	...
	public void setHref(String newHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.EICON_ELEMENT__HREF, oldHref, href));
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					EConfML1Package.EICON_ELEMENT__TITLE, oldTitle, title));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EXLinkReference.class) {
			...
			case EConfML1Package.EX_LINK_REFERENCE__HREF:
				return EConfML1Package.EICON_ELEMENT__HREF;
			case EConfML1Package.EX_LINK_REFERENCE__TITLE:
				return EConfML1Package.EICON_ELEMENT__TITLE;
			default:
				return -1;
			}
		}
