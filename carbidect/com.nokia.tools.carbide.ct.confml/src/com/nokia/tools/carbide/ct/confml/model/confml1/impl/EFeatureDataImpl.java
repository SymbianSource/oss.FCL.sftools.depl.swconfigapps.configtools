 ...
 * <ul>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml1.impl.EFeatureDataImpl#getSettings <em>Settings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EFeatureDataImpl extends ERefNamedElementImpl implements
	...
	protected EClass eStaticClass() {
		return EConfML1Package.Literals.EFEATURE_DATA;
	}
	...
	public EList<ESettingData> getSettings() {
		if (settings == null) {
			settings = new EObjectContainmentEList<ESettingData>(
					...
					EConfML1Package.EFEATURE_DATA__SETTINGS);
		}
		return settings;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ESettingDataContainer.class) {
			...
			case EConfML1Package.ESETTING_DATA_CONTAINER__SETTINGS:
				return EConfML1Package.EFEATURE_DATA__SETTINGS;
			default:
				return -1;
			}
		}
