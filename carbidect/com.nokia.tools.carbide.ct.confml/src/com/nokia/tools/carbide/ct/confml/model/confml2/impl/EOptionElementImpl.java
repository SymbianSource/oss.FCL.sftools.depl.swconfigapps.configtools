 ...
 * <ul>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getIcons <em>Icons</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.carbide.ct.confml.model.confml2.impl.EOptionElementImpl#getMap <em>Map</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case EConfML2Package.EOPTION_ELEMENT__DESCRIPTIONS:
			return ((InternalEList<?>) getDescriptions()).basicRemove(otherEnd,
					msgs);
		case EConfML2Package.EOPTION_ELEMENT__ICONS:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EIconContainer.class) {
			...
			case EConfML2Package.EICON_CONTAINER__ICONS:
				return EConfML2Package.EOPTION_ELEMENT__ICONS;
			default:
				return -1;
			}
		}
