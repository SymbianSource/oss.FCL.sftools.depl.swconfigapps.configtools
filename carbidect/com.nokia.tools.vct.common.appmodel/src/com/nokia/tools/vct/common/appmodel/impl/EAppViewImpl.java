 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getIconDescriptor <em>Icon Descriptor</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getIconTitle <em>Icon Title</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getIconURI <em>Icon URI</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppViewImpl#getUri <em>Uri</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EAppViewImpl extends EObjectImpl implements EAppView {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ESourceLocator.class) {
			switch (derivedFeatureID) {
				case EApplicationPackage.EAPP_VIEW__URI: return EApplicationPackage.ESOURCE_LOCATOR__URI;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ESourceLocator.class) {
			switch (baseFeatureID) {
				case EApplicationPackage.ESOURCE_LOCATOR__URI: return EApplicationPackage.EAPP_VIEW__URI;
				default: return -1;
			}
		}
