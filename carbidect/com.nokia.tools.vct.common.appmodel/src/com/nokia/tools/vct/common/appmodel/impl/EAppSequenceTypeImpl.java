 ...
 * <ul>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getTypeMap <em>Type Map</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getIconDescriptor <em>Icon Descriptor</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getIconTitle <em>Icon Title</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getIconURI <em>Icon URI</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMinInclusive <em>Min Inclusive</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMaxInclusive <em>Max Inclusive</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMinExclusive <em>Min Exclusive</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMaxExclusive <em>Max Exclusive</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMinLength <em>Min Length</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getLength <em>Length</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getTotalDigits <em>Total Digits</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#isRequired <em>Required</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#isDeprecated <em>Deprecated</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMinOccurs <em>Min Occurs</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMapKey <em>Map Key</em>}</li>
 *   <li>{@link com.nokia.tools.vct.common.appmodel.impl.EAppSequenceTypeImpl#getMapValue <em>Map Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EAppSequenceTypeImpl extends EObjectImpl implements EAppSequenceType {
	...
	public void setMinInclusive(Object newMinInclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_INCLUSIVE, oldMinInclusive, minInclusive));
	}
	...
	public void setMaxInclusive(Object newMaxInclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_INCLUSIVE, oldMaxInclusive, maxInclusive));
	}
	...
	public void setMinExclusive(Object newMinExclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_EXCLUSIVE, oldMinExclusive, minExclusive));
	}
	...
	public void setMaxExclusive(Object newMaxExclusive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_EXCLUSIVE, oldMaxExclusive, maxExclusive));
	}
	...
	public void setMinLength(Integer newMinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_LENGTH, oldMinLength, minLength));
	}
	...
	public void setLength(Integer newLength) {
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__LENGTH, oldLength, length));
	}
	...
	public void setMaxLength(Integer newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setTotalDigits(Integer newTotalDigits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EApplicationPackage.EAPP_SEQUENCE_TYPE__TOTAL_DIGITS, oldTotalDigits, totalDigits));
	}
	...
	public EList<String> getPattern() {
		if (pattern == null) {
			pattern = new EDataTypeUniqueEList<String>(String.class, this, EApplicationPackage.EAPP_SEQUENCE_TYPE__PATTERN);
		}
		return pattern;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_INCLUSIVE:
				return getMinInclusive();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_INCLUSIVE:
				return getMaxInclusive();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_EXCLUSIVE:
				return getMinExclusive();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_EXCLUSIVE:
				return getMaxExclusive();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_LENGTH:
				return getMinLength();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__LENGTH:
				return getLength();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_LENGTH:
				return getMaxLength();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__TOTAL_DIGITS:
				return getTotalDigits();
			case EApplicationPackage.EAPP_SEQUENCE_TYPE__PATTERN:
				return getPattern();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EAppTypeConstraints.class) {
			switch (derivedFeatureID) {
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_INCLUSIVE: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_INCLUSIVE;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_INCLUSIVE: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_INCLUSIVE;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_EXCLUSIVE: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_EXCLUSIVE;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_EXCLUSIVE: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_EXCLUSIVE;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_LENGTH: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_LENGTH;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__LENGTH: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__LENGTH;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_LENGTH: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_LENGTH;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__TOTAL_DIGITS: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__TOTAL_DIGITS;
				case EApplicationPackage.EAPP_SEQUENCE_TYPE__PATTERN: return EApplicationPackage.EAPP_TYPE_CONSTRAINTS__PATTERN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EAppTypeConstraints.class) {
			switch (baseFeatureID) {
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_INCLUSIVE: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_INCLUSIVE;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_INCLUSIVE: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_INCLUSIVE;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_EXCLUSIVE: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_EXCLUSIVE;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_EXCLUSIVE: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_EXCLUSIVE;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MIN_LENGTH: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MIN_LENGTH;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__LENGTH: return EApplicationPackage.EAPP_SEQUENCE_TYPE__LENGTH;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__MAX_LENGTH: return EApplicationPackage.EAPP_SEQUENCE_TYPE__MAX_LENGTH;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__TOTAL_DIGITS: return EApplicationPackage.EAPP_SEQUENCE_TYPE__TOTAL_DIGITS;
				case EApplicationPackage.EAPP_TYPE_CONSTRAINTS__PATTERN: return EApplicationPackage.EAPP_SEQUENCE_TYPE__PATTERN;
				default: return -1;
			}
		}
		if (baseClass == EAppSettingType.class) {
