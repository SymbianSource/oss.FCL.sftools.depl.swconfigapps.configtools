...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.vct.confml.model.confml1.EViewElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EViewElementItemProvider extends ECommonAttrsItemProvider
	 ...
	 * @generated
	 */
	public EViewElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EViewElement_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_EViewElement_name_feature",
						"_UI_EViewElement_type"),
				EConfML1Package.Literals.EVIEW_ELEMENT__NAME, true, false,
	...
	public String getText(Object object) {
		String label = ((EViewElement) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_EViewElement_type")
				: label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EViewElement.class)) {
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				...
				EConfML1Factory.eINSTANCE.createEGroup()));
