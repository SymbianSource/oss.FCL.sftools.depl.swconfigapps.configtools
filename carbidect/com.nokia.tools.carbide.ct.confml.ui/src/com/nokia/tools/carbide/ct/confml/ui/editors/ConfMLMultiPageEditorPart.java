...
import com.nokia.tools.carbide.ct.confml.ui.overview.ConfMLViewer;
import com.nokia.tools.carbide.ct.confml.ui.overview.IOverviewViewer;
 ...
 * </ul>
 */
public class ConfMLMultiPageEditorPart extends MultiPageEditorPart implements IResourceChangeListener{

	/** The text editor used in page 0. */
	private TextEditor editor;

	private String title = "ConfML Editor"; //will change later
	 ...
	 */
	public ConfMLMultiPageEditorPart() {
		super();
...
//		fTextEditor.addPropertyListener(fPropertyListener);
	...
	protected IOverviewViewer createDesignPage() {
		ConfMLViewer confmlViewer = new ConfMLViewer(getContainer());
