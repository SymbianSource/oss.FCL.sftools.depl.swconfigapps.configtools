...
public class ListDialogField extends DialogField {
		...
		if (fTableControl == null) {
			...
			if (fTableColumns == null) {
				...
				for (int i= 0; i < columns.length; i++) {
					...
					ColumnLayoutData data = columns[i];
	...
	public Composite getButtonBox(Composite parent) {
		if (fButtonsControl == null && fButtonLabels != null) {
			assertCompositeNotNull(parent);
	...
	*/
	...
	public ListViewerAdapter getFListViewerAdapter() {
		return fListViewerAdapter;
	}

	public void setFListViewerAdapter(ListViewerAdapter listViewerAdapter) {
		fListViewerAdapter = listViewerAdapter;
	}
	
	public void setContentProvider(IContentProvider contentProvider){
		this.fTable.setContentProvider(contentProvider);
	}
