...
/**
 * This is the action bar contributor for the EConfML1 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EConfML1ActionBarContributor extends
	...
	protected IAction showPropertiesViewAction = new Action(
			ConfMLXMIEditorPlugin.INSTANCE
	 ...
	 * @generated
	 */
	public EConfML1ActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("econfml1-settings"));
		toolBarManager.add(new Separator("econfml1-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				ConfMLXMIEditorPlugin.INSTANCE
						.getString("_UI_EConfML1Editor_menu"),
				"com.nokia.tools.vct.confml.model.confml1MenuID");
		...
		//
		createChildMenuManager = new MenuManager(ConfMLXMIEditorPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ConfMLXMIEditorPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
