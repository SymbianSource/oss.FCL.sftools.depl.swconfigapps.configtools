...
public class ImportConfMLFileRunnable implements IWorkspaceRunnable {

	private boolean importDirectory;
	private File source;
	private IContainer targetContainer;
	private boolean fixXInclude;
	...
	public ImportConfMLFileRunnable(boolean importDirectory, File source,
			IContainer targetContainer, boolean fixXInclude,
			boolean prettyPrint, boolean makeLinks,  String plugin_ID) {

		this.importDirectory = importDirectory;
		this.source = source;
		this.targetContainer = targetContainer;
		this.fixXInclude = fixXInclude;
		...
		if (importDirectory) {
			File[] list = source.listFiles(new FileFilter() {
				public boolean accept(File pathname) {
					...
					return (suffix.equalsIgnoreCase("confml"));
				}
			});
