 ...
 * <ul>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FileSystemEntrySettingImpl#isFile <em>File</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FileSystemEntrySettingImpl#getSourceFilePath <em>Source File Path</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FileSystemEntrySettingImpl#getTargetFilePath <em>Target File Path</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FileSystemEntrySettingImpl#getChosenOption <em>Chosen Option</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FileSystemEntrySettingImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileSystemEntrySettingImpl extends SettingImpl implements
	...
	public void setChosenOption(String newChosenOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfmlPackage.FILE_SYSTEM_ENTRY_SETTING__CHOSEN_OPTION, oldChosenOption, chosenOption));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConfmlPackage.FILE_SYSTEM_ENTRY_SETTING__CHOSEN_OPTION:
