...
import com.nokia.tools.s60ct.content.confml.ConfmlFactory;
import com.nokia.tools.s60ct.content.confml.ConfmlPackage;
import com.nokia.tools.s60ct.content.confml.Feature;
...
import com.nokia.tools.s60ct.content.confml.Icon;
...
public class ConfmlPackageImpl extends EPackageImpl implements ConfmlPackage {
	 ...
	 * @see com.nokia.tools.s60ct.content.confml.ConfmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getSimpleSetting_ChosenOption() {
	 ...
	 * @generated
	 */
	public EAttribute getSetting_RelevantAST() {
	 ...
	 * @generated
	 */
	public EAttribute getSetting_ConstraintAST() {
		return (EAttribute)settingEClass.getEStructuralFeatures().get(23);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSetting_GroupOptionMap() {
		return (EAttribute)settingEClass.getEStructuralFeatures().get(24);
	}
	 ...
	 * @generated
	 */
	public EAttribute getOption_RelevantAST() {
	 ...
	 * @generated
	 */
	public EAttribute getFileSystemEntrySetting_ChosenOption() {
	 ...
	 * @generated
	 */
	public EAttribute getFeature_RelevantAST() {
	...
	public void createPackageContents() {
		...
		createEAttribute(simpleSettingEClass, SIMPLE_SETTING__CHOSEN_OPTION);
		...
		createEAttribute(settingEClass, SETTING__RELEVANT_AST);
		createEAttribute(settingEClass, SETTING__CONSTRAINT_AST);
		createEAttribute(settingEClass, SETTING__GROUP_OPTION_MAP);
		...
		createEAttribute(optionEClass, OPTION__RELEVANT_AST);
		...
		createEAttribute(fileSystemEntrySettingEClass, FILE_SYSTEM_ENTRY_SETTING__CHOSEN_OPTION);
		...
		createEAttribute(featureEClass, FEATURE__RELEVANT_AST);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getSimpleSetting_ChosenOption(), ecorePackage.getEString(), "chosenOption", null, 0, 1, SimpleSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSetting_RelevantAST(), this.getObject(), "relevantAST", null, 0, 1, Setting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSetting_ConstraintAST(), this.getObject(), "constraintAST", null, 0, 1, Setting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(this.getGroup());
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType(ecorePackage.getEEList());
		g1.getETypeArguments().add(g2);
		EGenericType g3 = createEGenericType(this.getOption());
		g2.getETypeArguments().add(g3);
		initEAttribute(getSetting_GroupOptionMap(), g1, "groupOptionMap", null, 0, 1, Setting.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(settingEClass, this.getView(), "getView", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getOption_RelevantAST(), this.getObject(), "relevantAST", null, 0, 1, Option.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFileSystemEntrySetting_ChosenOption(), ecorePackage.getEString(), "chosenOption", null, 0, 1, FileSystemEntrySetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_RelevantAST(), this.getObject(), "relevantAST", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(featureEClass, this.getView(), "getView", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEEnum(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.class, "TYPE");
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.INT);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.STRING);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.REAL);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.SELECTION);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.BOOLEAN);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.FILE);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.FOLDER);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.SEQUENCE);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.DATE_TIME);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.DATE);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.TIME);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.DURATION);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.MULTISELECTION);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.SIMPLE_FILE);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.SIMPLE_FOLDER);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.FILESOURCE);
		addEEnumLiteral(typeEEnum, com.nokia.tools.s60ct.content.confml.TYPE.FILETARGET);
