 ...
 * <ul>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getMap <em>Map</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getMapSourceSetting <em>Map Source Setting</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getOptionValues <em>Option Values</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.OptionImpl#getRelevantAST <em>Relevant AST</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OptionImpl extends EObjectImpl implements Option {
	...
	private class SequenceContentAdapter extends EContentAdapter {
		...
		public void notifyChanged(Notification notification) {
			...
			if (notification.getNewStringValue() != null
				...
				if (eContainer instanceof SimpleSetting) {
					SimpleSetting parent = (SimpleSetting) eContainer;
					String choosenOption = parent.getChosenOption();
					if (choosenOption != null
							&& !parentContainsOptionKey(parent, choosenOption)) {
						parent.setChosenOption(null);
					}
				} else if (eContainer instanceof FilePath) {
				...
				if (updateValue) {
					if (eContainer instanceof SimpleSetting) {
						...
						parent.setChosenOption(notification
								.getNewStringValue());
	...
	public void setRelevantAST(Object newRelevantAST) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfmlPackage.OPTION__RELEVANT_AST, oldRelevantAST, relevantAST));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConfmlPackage.OPTION__RELEVANT_AST:
