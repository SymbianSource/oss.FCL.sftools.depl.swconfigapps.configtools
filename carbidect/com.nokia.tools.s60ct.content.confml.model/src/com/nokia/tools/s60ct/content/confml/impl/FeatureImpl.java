 ...
 * <ul>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getRelevant <em>Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getIconTitle <em>Icon Title</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getIconDescriptor <em>Icon Descriptor</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getIconURI <em>Icon URI</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#isComputedRelevant <em>Computed Relevant</em>}</li>
 *   <li>{@link com.nokia.tools.s60ct.content.confml.impl.FeatureImpl#getRelevantAST <em>Relevant AST</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends EObjectImpl implements Feature {
	...
	public void setRelevantAST(Object newRelevantAST) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfmlPackage.FEATURE__RELEVANT_AST, oldRelevantAST, relevantAST));
	}

	/**
	 * 
	 * Return view in which is this feature included
	 * 
	 * @generated NOT
	 */
	public View getView() {
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ConfmlPackage.FEATURE__RELEVANT_AST:
