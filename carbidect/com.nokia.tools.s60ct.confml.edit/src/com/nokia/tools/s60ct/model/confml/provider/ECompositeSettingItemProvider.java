...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.s60ct.model.confml.ECompositeSetting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ECompositeSettingItemProvider
	 ...
	 * @generated
	 */
	public ECompositeSettingItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ECompositeSetting)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ECompositeSetting_type") :
			getString("_UI_ECompositeSetting_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ECompositeSetting.class)) {
