...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.s60ct.model.confml.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConfmlPackage.Literals.VIEW__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConfmlPackage.Literals.VIEW__SHARED_SETTING_INSTANCES);
			childrenFeatures.add(ConfmlPackage.Literals.VIEW__SHARED_FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfmlPackage.Literals.VIEW__SHARED_SETTING_INSTANCES,
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfmlPackage.Literals.VIEW__SHARED_FEATURES,
				 ConfmlFactory.eINSTANCE.createEFeature()));
	}
