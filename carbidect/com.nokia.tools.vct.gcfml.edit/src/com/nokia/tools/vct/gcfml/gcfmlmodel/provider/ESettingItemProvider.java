...
/**
 * This is the item provider adapter for a {@link com.nokia.tools.vct.gcfml.gcfmlmodel.ESetting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ESettingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EGCFMLPackage.Literals.ESETTING__REF,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ESetting)object).getRef();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ESetting.class)) {
			case EGCFMLPackage.ESETTING__REF:
