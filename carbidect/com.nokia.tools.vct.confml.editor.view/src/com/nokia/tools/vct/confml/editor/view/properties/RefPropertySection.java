...
import static com.nokia.tools.vct.confml.editor.view.vemodel.EViewEditorPackage.Literals.EREF_PROPERTY__NAME;
import static com.nokia.tools.vct.confml.editor.view.vemodel.EViewEditorPackage.Literals.EREF_PROPERTY__UNIT;
import static com.nokia.tools.vct.confml.editor.view.vemodel.EViewEditorPackage.Literals.EREF_PROPERTY__VALUE;
...
public class RefPropertySection extends AbstractPropertySection {

	private Section control;
	private boolean refreshFlag;
	private ERefProperty ref;
	...
	public void createControls(Composite parent,
		...
		control.setText("Property Override");
		...
		unitText = createNamedField(formToolkit, content,
				"Unit:", EREF_PROPERTY__UNIT);
		valueText = createNamedField(formToolkit, content,
				"Value:", EREF_PROPERTY__VALUE);
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (firstElement instanceof ERefProperty) {
				ref = (ERefProperty) firstElement;
			}
