...
public class SetNameOverrideCommand extends SetFeatureCommand {

	public SetNameOverrideCommand(EDescriptionContainer ref, String newValue) {
		super(ref, EViewEditorPackage.Literals.ESETTING_REF__NAME, newValue);
	}
}
