...
import com.nokia.tools.vct.crml.crmodel.presentation.ECRMLEditor;
...
public class EditorSelectionHandler extends
	...
	public boolean isCompatibleModelElementEditorSelectionHandler(
			IEditorPart part) {
		return (part instanceof ECRMLEditor);
	}

	public IStatus handleOpenTreeEditorWithSelection(IEditorPart part,
			Object selection) {

		if (part instanceof ECRMLEditor) {
			((ECRMLEditor) part).setSelectionToViewer(Arrays
