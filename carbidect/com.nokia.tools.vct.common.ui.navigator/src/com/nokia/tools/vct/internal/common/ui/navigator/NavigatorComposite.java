...
public class NavigatorComposite extends Canvas implements KeyListener {
	...
	public NavigatorComposite(Composite parent, int style,
		...
		tooltipBackgroundColor = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.TooltipBackgroundColor");
		tooltipForegroundColor = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.TooltipForegroundColor");
