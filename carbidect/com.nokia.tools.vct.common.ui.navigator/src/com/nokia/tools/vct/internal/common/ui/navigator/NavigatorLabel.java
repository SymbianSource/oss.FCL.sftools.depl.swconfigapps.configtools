...
public class NavigatorLabel extends Item {
	...
	public NavigatorLabel(NavigatorButton button) {
		...
		activeSelectionBackground = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.ActiveSelectionBackground");
		activeSelectionForeground = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.ActiveSelectionForeground");
		inactiveSelectionBackground = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.InactiveSelectionBackground");
		inactiveSelectionForeground = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.inactiveSelectionForeground");
		borderHighlightColor = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.BorderHighlightColor");
		borderShadowColor = colorRegistry.get("com.nokia.tools.vct.common.ui.navigator.BorderShadowColor");
	...
	private Color calculateBackground(boolean focused) {
		if (isSelected()) {
			return focused ? activeSelectionBackground : inactiveSelectionBackground;
		}
	...
	private Color calculateForeground(boolean focused) {
		if (isSelected()) {
			return focused ? activeSelectionForeground : inactiveSelectionForeground;
		}
	...
	public void setText(String text) {
		checkWidget();
		if (labelText!=null&&labelText.equals(text)) {
			return;
		}
		this.labelText = text;
		markDirty();
	...
	protected void paint(GC gc) {
		...
		if (!this.selected) {
			gc.setForeground(borderHighlightColor);
		} else {
